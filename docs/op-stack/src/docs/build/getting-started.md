...
Failure to account for gas price fluctuations can cause deployment to fail, so when in doubt, err on the side of a little too much. You can retrieve the excess ETH later if needed.
