---
title: "Add op-alloy to your project"
description: "Add the op-alloy crates to a Rust project with Cargo and pick the feature flags you need."
diataxis: how-to
---
...
To add `no_std` support to a crate, ensure the [check_no_std](https://github.com/ethereum-optimism/optimism/blob/develop/rust/op-alloy/scripts/check_no_std.sh)
