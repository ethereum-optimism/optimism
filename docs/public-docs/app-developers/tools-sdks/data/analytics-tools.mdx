...
[Envio](https://envio.dev/) provides indexing and historical data access for OP Chains.

*   [HyperIndex](https://docs.envio.dev/docs/HyperIndex/overview): build custom indexers in TypeScript and query the indexed data through a GraphQL API.
*   [HyperSync](https://docs.envio.dev/docs/HyperSync/overview): query historical blocks, transactions and logs without going through JSON-RPC.

See Envio's [supported networks](https://docs.envio.dev/docs/HyperSync/hypersync-supported-networks) for the OP Chains it covers.
