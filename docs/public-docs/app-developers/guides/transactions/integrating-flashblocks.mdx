...
<NormativeSpec
  what="The Flashblocks JSON-RPC interface"
  title="Flashblock JSON-RPC APIs section of the Flashblocks specification"
  href="https://specs.optimism.io/protocol/flashblocks.html#flashblock-json-rpc-apis"
  note="This guide covers reading pre-confirmed state from your app; it does not restate the spec."
/>
