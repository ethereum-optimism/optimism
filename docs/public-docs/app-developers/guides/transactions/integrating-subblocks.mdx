...
<Info>
  ...
  On a Lagoon chain the stream also carries the block's post-execution transaction outside the transaction list — see [the post-execution transaction](/op-stack/features/subblocks#the-post-execution-transaction).
</Info>
