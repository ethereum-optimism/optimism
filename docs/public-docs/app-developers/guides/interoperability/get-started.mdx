...
<CardGroup cols={2}>
  ...
  <Card title="Transaction tutorials" icon="arrow-right-arrow-left" href="/app-developers/tutorials/transactions/sdk-estimate-costs">
    
  </Card>
  <Card title="Bridging tutorials" icon="bridge-water" href="/app-developers/tutorials/bridging/standard-bridge-standard-token">
