...
Consider directly extending or modifying the [`StandardBridge`](https://github.com/ethereum-optimism/optimism/blob/87dd5a4743380b717dac44a4e55c5e6e60e32684/op-contracts/src/universal/StandardBridge.sol) contract before building your own bridge contracts from scratch.
...
*   [NFT Bridge](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/op-contracts/src/L1/L1ERC721Bridge.sol)
