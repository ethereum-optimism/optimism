...
**Description**: [SwiftNodes](https://swiftnodes.io/) offers [free and paid plans](https://swiftnodes.io/#pricing) for the following [networks](https://swiftnodes.io/optimism-rpc):

**Supported Testnets**: n/a

**Supported Mainnets**: OP Mainnet, Base, Zora, Unichain, Fraxtal, Mode, Soneium
