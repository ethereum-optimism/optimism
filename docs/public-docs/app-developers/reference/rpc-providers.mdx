...
**Description**: [Goldsky](https://docs.goldsky.com/edge-rpc/introduction) offers [free and paid plans](https://docs.goldsky.com/pricing/summary#edge-rpc) for the following [networks](https://docs.goldsky.com/chains/supported-networks):
...
**Description**: [PublicNode](https://www.publicnode.com/) by Allnodes provides fast, free, and privacy-first RPC endpoints for the following networks:
...
[Goldsky Boost](https://docs.goldsky.com/boost) is a free cache in front of your existing RPC provider. It serves eligible historical reads from indexed data and forwards other requests to your provider.

**Supported Testnets**: Base Sepolia
