...
<NormativeSpec
  what="The interoperability predeploy contract set"
  title="interop predeploys specification"
  href="https://specs.optimism.io/interop/predeploys.html"
  note="This page is an address and orientation reference; it does not restate the spec."
/>
