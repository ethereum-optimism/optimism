...
description: Understand how the Contests example composes with cross-chain events, using the CrossL2Inbox to consume events emitted by contracts on any OP Stack chain.
...
<NormativeSpec
  what="Cross-chain event validation through the CrossL2Inbox"
  title="CrossL2Inbox section of the interop predeploys specification"
  href="https://specs.optimism.io/interop/predeploys.html#crossl2inbox"
  note="This page walks an example that builds on it; it does not restate the spec."
/>
