...
Crosschain ETH transfers across OP Stack chains are facilitated through the [SuperchainETHBridge](https://github.com/ethereum-optimism/optimism/blob/develop/op-contracts/src/L2/SuperchainETHBridge.sol) contract.
...
<Steps>
  ...
  <Steps>
    ...
    <Step title="Download the SuperchainETHBridge ABI">
        ...
        ```sh
        curl https://raw.githubusercontent.com/ethereum-optimism/optimism/refs/heads/develop/op-contracts/snapshots/abi/SuperchainETHBridge.json > src/SuperchainETHBridge.abi.json
        ```
    </Step>
