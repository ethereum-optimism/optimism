---
title: Bridge tokens with the Standard Bridge
description: Learn how to bridge a standard or custom ERC-20 token from Ethereum to an OP Stack chain using the Standard Bridge.
diataxis: tutorial
---
...
In this tutorial, you'll learn how to bridge an ERC-20 token from Ethereum to an OP Stack chain using the Standard Bridge system.
