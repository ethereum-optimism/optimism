...
This tutorial explains how you can create a custom token that conforms to the [`IOptimismMintableERC20`](https://github.com/ethereum-optimism/optimism/blob/develop/op-contracts/src/universal/OptimismMintableERC20Factory.sol) interface so that it can be used with the Standard Bridge system.
...
The Standard Bridge system requires that L2 representations of L1 tokens implement the [`IOptimismMintableERC20`](https://github.com/ethereum-optimism/optimism/blob/develop/op-contracts/src/universal/OptimismMintableERC20Factory.sol) interface.
...
```
  ...
  Take a moment to review the example contract. It's closely based on the official [`OptimismMintableERC20`](https://github.com/ethereum-optimism/optimism/blob/v1.12.2/op-contracts/src/universal/OptimismMintableERC20.sol) contract with one key modification:
