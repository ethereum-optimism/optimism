...
<TutorialSetupNodeProject lib="@eth-optimism/viem" folder="bridging-erc20-tokens" packages="@eth-optimism/viem viem" />
...
<TutorialSetupRepl lib="@eth-optimism/viem" />
...
```
  ...
  <Info>
    If you're coming from the [Bridge tokens with the Standard
