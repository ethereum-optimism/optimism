...
## Step 2: Fix your sequencing-window budget
...
sequencing window. Decide now how much safe-head delay your chain's users
tolerate; that number, not the 12-hour ceiling, is your real budget.
...
*   [Fee parameter calculator](https://docs.google.com/spreadsheets/d/1V3CWpeUzXv5Iopw8lBSS8tWoSzyR4PDDwV9cu2kKOrs/edit):
    the working cost model behind Steps 4 and 5. Hand-maintained
    spreadsheet, as of 2026-07-16.
