...
| The node is an existing op-geth deployment                    | Migration to op-reth       | op-geth is end-of-support; the [notice](/notices/op-geth-deprecation) carries the migration plan.                                            |
