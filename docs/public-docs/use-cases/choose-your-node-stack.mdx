...
Read the [node architecture overview](/node-operators/reference/architecture)
and take away:
...
Read the [end-of-support notice](/notices/archive/op-geth-deprecation) and take
...
| The node is an existing op-geth deployment                    | Migration to op-reth       | op-geth is end-of-support; the [notice](/notices/archive/op-geth-deprecation) carries the migration plan.                                            |
