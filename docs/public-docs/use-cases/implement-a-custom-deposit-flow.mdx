...
*   **Standard Bridge with a custom token**: follow the custom-token path of
    [Create an L2 token for the Standard Bridge](/app-developers/tutorials/bridging/standard-bridge-standard-token)
