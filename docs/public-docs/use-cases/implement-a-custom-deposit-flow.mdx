...
<NormativeSpec
  what="The deposit flow"
  title="deposits specification"
  href="https://specs.optimism.io/protocol/deposits.html"
  note="This guide covers choosing and building against an entry point; it does not restate the spec."
/>
