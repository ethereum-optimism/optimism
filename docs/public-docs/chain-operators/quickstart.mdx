---
title: "Chain operator quickstart"
...
This page orients you on the key components and the sequence of steps, then hands you off to the [full deployment tutorial](/chain-operators/tutorials/create-l2-rollup/create-l2-rollup).
...
<Card title="Start the deployment tutorial" icon="rocket" href="/chain-operators/tutorials/create-l2-rollup/create-l2-rollup">
  Deploy a complete OP Stack testnet, component by component, with a working automated example alongside.
</Card>

## Next Steps

Of course there is a lot more work to do to ensure you're operating a highly available chain.
