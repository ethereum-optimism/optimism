...
<NormativeSpec
  what="The DA footprint block limit"
  title="DA footprint block limit section of the Jovian execution engine specification"
  href="https://specs.optimism.io/protocol/jovian/exec-engine.html#da-footprint-block-limit"
  note="This page explains the motivation and mechanics; it does not restate the spec."
/>
