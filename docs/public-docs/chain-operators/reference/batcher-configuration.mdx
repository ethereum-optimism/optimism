...
that posts L2 sequencer data to L1 to make it available for verifiers. The
...
Maximum number of blocks to add to a span batch. The default value is `0`,
meaning no maximum.
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_ADDITIONAL_ENDPOINTS=http://builder1:8545,http://builder2:8545`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_TX_SIZE_LOWER_LIMIT=150`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_TX_SIZE_UPPER_LIMIT=20000`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_BLOCK_SIZE_LOWER_LIMIT=2000`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_BLOCK_SIZE_UPPER_LIMIT=130000`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_CONTROLLER_TYPE=quadratic`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_UNSAFE_DA_BYTES_LOWER_THRESHOLD=3200000`</Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Environment Variable">`OP_BATCHER_THROTTLE_UNSAFE_DA_BYTES_UPPER_THRESHOLD=12800000`</Tab>
</Tabs>
