...
description: Understand what OP Contracts Manager is, why it exists, and how it deploys and upgrades the L1 contracts for OP Stack chains in a single transaction.
...
<NormativeSpec
  what="OP Contracts Manager"
  title="OP Contracts Manager specification"
  href="https://specs.optimism.io/experimental/op-contracts-manager.html"
  note="This page explains what OPCM is for and how it is used; it does not restate the spec."
/>
