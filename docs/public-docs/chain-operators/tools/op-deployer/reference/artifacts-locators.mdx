---
title: Artifacts Locators
description: Learn how OP Deployer uses artifacts locators to point to contract artifacts.
---
...
*   `file://` locators, which point to a directory on local disk containing the artifacts.
    *   ex: `file://<path-to-repo-root>/op-contracts/forge-artifacts`
