...
<NormativeSpec
  what="The DA server interface"
  title="DA server section of the Alt-DA mode specification"
  href="https://specs.optimism.io/experimental/alt-da.html#da-server"
  note="This guide covers building an integration against it; it does not restate the spec."
/>
