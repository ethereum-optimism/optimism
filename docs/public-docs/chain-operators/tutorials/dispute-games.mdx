...
2.  Optionally deploys a new [`DelayedWETH`](https://github.com/ethereum-optimism/optimism/blob/6dc586d551f55b2b3a607cfcca9d3d272dec84d7/op-contracts/src/dispute/DelayedWETH.sol) contract
