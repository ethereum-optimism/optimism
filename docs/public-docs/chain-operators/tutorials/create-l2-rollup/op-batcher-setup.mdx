...
<Warning>
  **The execution-layer step of this tutorial is being rewritten for op-reth.** The legacy [Spin up sequencer](./op-geth-setup) step used op-geth, which reached end-of-support on 2026-05-31. Configure your execution layer with **op-reth** via the [execution clients guide](/node-operators/guides/configuration/execution-clients) until the op-reth setup step lands. See the [op-geth deprecation notice](/notices/op-geth-deprecation).
</Warning>
