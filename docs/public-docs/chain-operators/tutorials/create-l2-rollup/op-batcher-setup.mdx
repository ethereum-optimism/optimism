...
<Tabs>
  ...
  <Tab title="Build from source">
    ...
    <Info>
      This guide uses `op-batcher/v1.13.2`, compatible with the op-node and op-reth versions from the [sequencer setup](./op-reth-setup).
