...
<Warning>
  **This page needs to be updated for op-reth.** The node configurations below were written for op-geth, which has reached end-of-support — see the [op-geth deprecation notice](/notices/op-geth-deprecation).
</Warning>
