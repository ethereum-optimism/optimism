...
nodes only, running SDM-capable software is all you need to do.

## Operator opt-in

A producer appends a PostExec transaction only when two separate things are true: Lagoon is active
