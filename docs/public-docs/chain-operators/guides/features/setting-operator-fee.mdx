...
<NormativeSpec
  what="The operator fee parameters"
  title="operator fee parameter configuration section of the Isthmus system config specification"
  href="https://specs.optimism.io/protocol/isthmus/system-config.html#operator-fee-parameter-configuration"
  note="This guide covers setting the parameters on your chain; it does not restate the spec."
/>
