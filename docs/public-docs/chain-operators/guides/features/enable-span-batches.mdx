...
<NormativeSpec
  what="The span batch format"
  title="span batches specification"
  href="https://specs.optimism.io/protocol/delta/span-batches.html"
  note="This guide covers enabling the format on op-batcher; it does not restate the spec."
/>
