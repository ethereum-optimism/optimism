...
The state is stored and modified by the execution client. The default is [`op-reth`](https://github.com/paradigmxyz/reth); [`op-geth`](https://op-geth.optimism.io/) — a [slightly modified](https://op-geth.optimism.io/) version of standard [geth](https://geth.ethereum.org/) — is also supported but reaches [end-of-support](/notices/op-geth-deprecation) on 2026-05-31.
