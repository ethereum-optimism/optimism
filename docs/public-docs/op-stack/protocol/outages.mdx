...
<NormativeSpec
  what="Bypassing the sequencer with deposit transactions"
  title="deposits specification"
  href="https://specs.optimism.io/protocol/deposits.html#user-deposited-transactions"
  note="This page explains outage types and mitigations; it does not restate the spec."
/>
...
Both outage types can be circumvented by submitting transactions directly to the [`OptimismPortal`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L1/OptimismPortal2.sol#L684) contract on L1 with certain important caveats.
...
Users can always bypass the Sequencer by sending L2 transactions directly to the [`OptimismPortal`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L1/OptimismPortal2.sol#L684) contract on L1.
...
Users of OP Stack chains can always bypass the sequencer and include transactions in the L2 chain by sending their L2 transactions directly to the [`OptimismPortal`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L1/OptimismPortal2.sol#L684) contract on L1.
