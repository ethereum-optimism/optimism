...
The current OP Stack implementation supports Ethereum as its Data Availability Layer. Source data can be derived from any piece of information accessible on the Ethereum blockchain, including calldata, events, and EIP-4844 data blobs.
