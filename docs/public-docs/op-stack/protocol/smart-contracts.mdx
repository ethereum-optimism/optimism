...
Both paths apply upgrades through the [OP Contracts Manager](/chain-operators/reference/opcm),
which deploys and upgrades the L1 contracts as a versioned set.
