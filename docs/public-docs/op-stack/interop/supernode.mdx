...
*   Read the [supernode configuration guide](/node-operators/guides/configuration/supernode) for recommended settings and a starter configuration, and the [op-supernode configuration reference](/node-operators/reference/op-supernode-config) for the full flag catalogue.
