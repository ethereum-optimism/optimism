...
*   **Stop 2.** [OP Stack architecture](/op-stack/architecture): the system
    view, covering the components, who runs each, and how a transaction moves
    through them.
*   **Stop 3.** [Design philosophy & principles](/op-stack/protocol/design-principles):
    the four pillars that explain why the stack is built the way it is.
*   **Stop 4.** [Differences from Ethereum](/op-stack/protocol/differences):
    what "EVM equivalent" means in practice and the small set of behaviors
    that differ.
*   **Stop 5.** [OP Stack components](/op-stack/protocol/components): the
    conceptual layers of the stack and the software modules that fill them.

## Project 1: Deploy your own chain

*   **Stop 6.** [Creating your own L2 rollup testnet](/chain-operators/tutorials/create-l2-rollup):
