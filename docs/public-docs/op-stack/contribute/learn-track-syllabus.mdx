...
| 8 | [Transaction fees on OP Mainnet](/op-stack/transactions/fees) | Concept | The fee components of a transaction; the economic consequence of the flow in stop 6. |
