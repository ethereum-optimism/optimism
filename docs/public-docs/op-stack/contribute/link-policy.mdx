...
description: The canonical form for every link from docs.optimism.io into the specs, source repositories, and other pages — and the linter that enforces it.
diataxis: reference
---
