...
*   Ready to get started? Follow the [Deploy the Bridged USDC Standard guide](/op-stack/features/deploy-bridged-usdc-standard), which walks through the [reference implementation's setup](https://github.com/defi-wonderland/opUSDC#setup).
