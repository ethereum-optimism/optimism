...
The consequence worth internalizing is that for a rebated transaction, the EVM's measurement and
the chain's accounting come apart. The receipt's gas-used field reports the **canonical** gas: what
...
That last row is the one that bites. A block may now end in a transaction type your decoder has
