...
Constant, iterative improvement of the security mechanisms that safeguard OP Stack users is a top priority for [Optimism](/governance/evolution-and-experimentation).
