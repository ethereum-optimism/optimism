...
The [`OptimismPortal`](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/op-contracts/src/L1/OptimismPortal.sol) is the low-level L1 message passing contract present on all standard OP Stack chains.
...
The `GUARDIAN` can pause and unpause L2-to-L1 transactions at any time by calling the [`pause`](https://github.com/ethereum-optimism/optimism/blob/856c08bf84d9aa829d1e764fc8e9a37d41960ba0/op-contracts/src/L1/SuperchainConfig.sol#L66-L71) and [`unpause`](https://github.com/ethereum-optimism/optimism/blob/856c08bf84d9aa829d1e764fc8e9a37d41960ba0/op-contracts/src/L1/SuperchainConfig.sol#L73-L78) functions on the `SuperchainConfig` contract.
