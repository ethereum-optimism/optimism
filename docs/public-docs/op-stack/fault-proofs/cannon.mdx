...
<NormativeSpec
  what="The Cannon fault proof virtual machine"
  ...
  note="This page describes the offchain implementation; it does not restate the spec."
/>
...
<Info>
  ...
  reached end-of-support (see [End of Support for op-geth and op-program](/notices/archive/op-geth-deprecation)). Current dispute games use the
