---
title: "`kona-executor` Extensions"
diataxis: how-to
---
...
let hinter = ...;
let parent_header = ...;
let receipt_builder = alloy_op_evm::block::OpAlloyReceiptBuilder::default();
...
For more complex customizations involving multiple precompiles, custom opcodes, or specialized execution logic, refer to the [`FpvmOpEvmFactory`](https://github.com/ethereum-optimism/optimism/blob/develop/rust/kona/bin/client/src/fpvm_evm/factory.rs) implementation in the `kona-client` for a comprehensive example.
