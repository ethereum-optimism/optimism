...
<NormativeSpec
  what="The fault proof system"
  title="fault proof specification"
  href="https://specs.optimism.io/fault-proof/index.html"
  note="This page is a conceptual explainer; it does not restate the spec."
/>

<Info>
  **Learn the OP Stack — stop 11 of 13.**
  ...
  continue to
  [OP Stack interoperability explainer](/op-stack/interop/explainer).
</Info>
...
The Guardian's safety hatches, including the delay period on proposals and the ability to fall back to a permissioned game, are described in the [OP Stack security model](/op-stack/security/faq-sec-model#fault-proofs).
...
See the [specs](https://specs.optimism.io/fault-proof/stage-one/bond-incentives.html?utm_source=op-docs&utm_medium=docs) for more details.
