...
In [Optimistic Rollups like OP Stack Chains](/op-stack/architecture) there is a \~1 week challenge period during which users can challenge a proposal if they believe it to be incorrect.
