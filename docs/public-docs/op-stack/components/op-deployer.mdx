---
title: op-deployer
description: Canonical hub for op-deployer, the OP Stack chain deployment tool, covering what it does, who runs it, and where its guides, reference, releases, and source live.
...
see the
[deprecation notice](/notices/archive/op-deployer-upgrade-deprecation) for the
...
*   [Deploy L1 contracts with op-deployer](/chain-operators/tutorials/create-l2-rollup/op-deployer-setup):
    ...
    [Install op-deployer](/chain-operators/tools/op-deployer/installation).
