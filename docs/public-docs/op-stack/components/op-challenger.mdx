---
title: op-challenger
description: Canonical hub for op-challenger, the OP Stack dispute game challenge agent — what it does, who runs it, and where its guides, releases, source, and spec live.
