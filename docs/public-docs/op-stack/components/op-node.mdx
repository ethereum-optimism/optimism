---
title: op-node
description: Canonical hub for op-node, the OP Stack rollup node in Go — what it does, who runs it, and where its guides, reference, releases, source, and spec live.
