...
data availability layer as Ethereum calldata or blob transactions. It can
also select between calldata and blobs automatically based on current L1
prices.
...
*   [Configure the batcher](/chain-operators/guides/configuration/batcher):
    ...
    throttling.
*   [Post batch data as blobs](/chain-operators/guides/features/blobs): switch
    the chain's data availability type to blobs.
