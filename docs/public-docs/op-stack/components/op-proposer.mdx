---
title: op-proposer
description: Canonical hub for op-proposer, the OP Stack output proposer — what it does, who runs it, and where its guides, reference, releases, source, and spec live.
