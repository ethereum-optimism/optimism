...
by the [`SystemConfig`](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/op-contracts/src/L1/SystemConfig.sol) contract on L1 and read by the L2 [derivation](#l2-chain-derivation) process.
