...
<Info>
  ...
  If you are experiencing rate limiting issues or need websocket functionality, consider [running your own node](/node-operators/overview) or signing up for a [third-party RPC provider](/app-developers/reference/rpc-providers).
</Info>
...
| Subblocks websocket URL <sup>3</sup>     | [wss://op-mainnet-fb-ws-pub.optimism.io/ws](wss://op-mainnet-fb-ws-pub.optimism.io/ws)   |
...
| Subblocks websocket URL <sup>3</sup>     | [wss://op-sepolia-fb-ws.optimism.io/ws](wss://op-sepolia-fb-ws.optimism.io/ws)             |
