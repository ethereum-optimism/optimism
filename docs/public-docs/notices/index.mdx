...
network upgrades, deprecations, and operational changes. Each network upgrade
also has a permanent entry in the
[hardfork registry](/op-stack/protocol/network-upgrades) recording its
activation times, governing spec, and minimum component versions — notices are
archived after activation, registry pages are forever.
