...
| `op-reth`        | [`v2.3.0`](https://github.com/ethereum-optimism/optimism/releases/tag/op-reth%2Fv2.3.0)   | Must be updated **prior** to the activation timestamp. Required for EIP-7825 gas limit enforcement, MODEXP/P256VERIFY gas changes, and BN256 pairing input size reduction. |
