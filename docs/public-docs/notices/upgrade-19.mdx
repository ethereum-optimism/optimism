...
| `op-reth`        | `v2.3.2`     | Must be updated **prior** to the activation timestamp. Fixes SCR loading for `op-sepolia` and `op-mainnet`. Adds `engine_getPayloadV5` support for Karst. Replaces `v2.3.1`, which is now deprecated. |
