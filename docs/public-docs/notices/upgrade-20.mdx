...
| `op-reth` | [2.4.4](https://github.com/ethereum-optimism/optimism/releases/tag/op-reth%2Fv2.4.4) | No Upgrade 20 configuration change is required, and there is no hardfork activation. |
