...
Now that you have [installed the `kona-node`](/rust/kona/node/install/overview),
it's time to run it.
...
-   **[Configuration](/rust/kona/node/configuration)** - Configure your node
-   **[Monitoring](/rust/kona/node/monitoring)** - Set up logs, metrics, and observability
