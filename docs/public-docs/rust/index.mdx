...
<CardGroup cols={2}>
  <Card title="Kona" icon="lock" href="https://github.com/ethereum-optimism/optimism/tree/develop/rust/kona">
    Modular rollup node and fault proof system. Spec-compliant, performant, and extensible with `no_std` support.
  </Card>
  <Card title="op-reth" icon="bolt" href="/node-operators/op-reth/index">
