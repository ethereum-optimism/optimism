...
op-program has also reached end of support, replaced by kona-client for fault proofs; the same [notice](/notices/op-geth-deprecation) covers both migrations.
