...
<Info>
  For details on additional values, see [RPC Receipts](https://github.com/ethereum-optimism/optimism/blob/develop/op-service/sources/receipts_rpc.go#L158-L185).
</Info>
