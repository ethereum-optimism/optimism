...
<NormativeSpec
  what="The rollup node's L2 output RPC method"
  title="L2 output RPC method section of the rollup node specification"
  href="https://specs.optimism.io/protocol/rollup-node.html#l2-output-rpc-method"
  note="This page is an operator reference for the full op-node RPC surface; it does not restate the spec."
/>
