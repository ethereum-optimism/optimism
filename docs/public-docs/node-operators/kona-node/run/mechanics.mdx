...
<NormativeSpec
  what="The rollup node"
  title="rollup node specification"
  href="https://specs.optimism.io/protocol/rollup-node.html"
  note="This page is an orientation to how kona-node implements it; it does not restate the spec."
/>
...
of the `kona-node`, visit the [Node Design section](/rust/kona/node/design/intro).
