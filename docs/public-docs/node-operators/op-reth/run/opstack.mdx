---
title: "Running op-reth on OP Stack chains"
diataxis: how-to
---
...
<NormativeSpec
  what="The L2 execution engine"
  title="L2 execution engine specification"
  href="https://specs.optimism.io/protocol/exec-engine.html"
  note="This guide covers running op-reth on OP Stack chains; it does not restate the spec."
/>
...
[sequencer]: https://specs.optimism.io/background.html#sequencers
[op-stack-spec]: https://github.com/ethereum-optimism/specs/blob/main/specs
[l2-el-spec]: https://specs.optimism.io/protocol/exec-engine.html
