---
title: "op-reth db stage-checkpoints set"
diataxis: reference
---
...
```bash
$ op-reth db stage-checkpoints set --help
```
```txt
Usage: op-reth db stage-checkpoints set [OPTIONS] --stage <STAGE> --block-number <BLOCK_NUMBER>
