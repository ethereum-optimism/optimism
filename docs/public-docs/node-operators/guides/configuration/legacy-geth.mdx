...
Everything post-Bedrock is served by op-reth directly.
...
The `--rollup.historicalrpc` flag tells your execution client where to route requests for pre-Bedrock blocks.
