...
<Info>
  **Learn the OP Stack — stop 13 of 13.**
  ...
  [Learn the OP Stack](/op-stack/learn/index) for where to go next.
</Info>
...
<Info>
  ...
  [kona-node Docker guide](/node-operators/kona-node/run/docker), which ships
