...
Public developer documentation for `docs.optimism.io` lives in [`public-docs/`](./public-docs/).
To update the docs site, edit files in `public-docs/` and open a PR against `develop`.
See [`public-docs/DOCS_CONTRIBUTING.md`](./public-docs/DOCS_CONTRIBUTING.md) for style guide and contribution standards.
...
[Optimism Docs]: https://github.com/ethereum-optimism/optimism/tree/develop/public-docs
