...
func TestFees(t *testing.T) {
	...
	forkGetter, forkValidator := validators.AcquireRequiresNotL2Fork(chainIdx, rollup.Regolith)
	...
	// Run regolith test
	forkGetter, forkValidator = validators.AcquireRequiresL2Fork(chainIdx, rollup.Regolith)
	_, notForkValidator := validators.AcquireRequiresNotL2Fork(chainIdx, rollup.Ecotone)
	systest.SystemTest(t,
		feesTestScenario(lowLevelSystemGetter, walletGetter, chainIdx, forkGetter),
		lowLevelSystemValidator,
		walletValidator,
	...
	// Run ecotone test
	forkGetter, forkValidator = validators.AcquireRequiresL2Fork(chainIdx, rollup.Ecotone)
	_, notForkValidator = validators.AcquireRequiresNotL2Fork(chainIdx, rollup.Fjord)
	systest.SystemTest(t,
		feesTestScenario(lowLevelSystemGetter, walletGetter, chainIdx, forkGetter),
		lowLevelSystemValidator,
		walletValidator,
	...
	// Run fjord test
	forkGetter, forkValidator = validators.AcquireRequiresL2Fork(chainIdx, rollup.Fjord)
	systest.SystemTest(t,
		feesTestScenario(lowLevelSystemGetter, walletGetter, chainIdx, forkGetter),
		lowLevelSystemValidator,
		walletValidator,
