...
const initialState = {
  ...
  configureItemToPlasmaLoad: false,
  configureItemToPlasmaError: null,
...
function sellReducer (state = initialState, action) {
  switch (action.type) {
    ...
    case 'CONFIGURE_ITEM_TO_PLASMA':
      return {
        ...state,
        configureItemToPlasmaLoad: true,
        configureItemToPlasmaError: null,
      }
    case 'CONFIGURE_ITEM_TO_PLASMA_SUCCESS':
      return {
        ...state,
        configureItemToPlasmaLoad: false,
        configureItemToPlasmaError: false,
      }
    case 'CONFIGURE_ITEM_TO_PLASMA_FAILURE':
      return {
        ...state,
        configureItemToPlasmaLoad: false,
        configureItemToPlasmaError: action.payload,
      }
