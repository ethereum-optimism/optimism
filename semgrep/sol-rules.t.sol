...
contract SemgrepTest__sol_style_malformed_require {
    function test() {
        ...
        // ok: sol-style-malformed-require
        require(_addrs[i] != _addrs[j], string.concat("DeployUtils: check failed, duplicates at ", LibString.toString(i), ",", LibString.toString(j)));
...
contract SemgrepTest__sol_style_malformed_revert {
    function test() {
        ...
        // ok: sol-style-malformed-revert
        revert(string.concat("DeployUtils: check failed, duplicates at ", LibString.toString(i), ",", LibString.toString(j)));
