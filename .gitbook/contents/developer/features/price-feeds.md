...
1. Witnet
2. Hybrid Compute
3. Spin your own price feed using Boba Straw
...
Boba-Straw is a spin-up-your-own price feed based on ChainLink's implementation and can handle price data aggregation from multiple trusted external entities (data oracles), on-chain.

[\[code\]](https://github.com/bobanetwork/boba_legacy/tree/9e8c2bf2bc261858ebd35d653148ccd87b8616ae/packages/boba/contracts/contracts/oracle)
[\[examples\]](https://github.com/bobanetwork/boba_legacy/tree/9e8c2bf2bc261858ebd35d653148ccd87b8616ae/boba_examples/boba-straw)

### I want to be a data source

To be a data oracle and help run your Boba-Straw by submitting price data:
