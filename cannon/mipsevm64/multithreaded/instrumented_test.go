...
func vmFactory(state *State, po mipsevm64.PreimageOracle, stdOut, stdErr io.Writer, log log.Logger) mipsevm64.FPVM {
...
func TestInstrumentedState_MultithreadedProgram(t *testing.T) {
	state := testutil.LoadELFProgram(t, "../../testdata/example64/bin/multithreaded.elf", CreateInitialState, false)
...
func TestInstrumentedState_Alloc(t *testing.T) {
	...
	state := testutil.LoadELFProgram(t, "../../testdata/example64/bin/alloc.elf", CreateInitialState, false)
