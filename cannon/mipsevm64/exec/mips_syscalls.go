...
func HandleSysWrite(a0, a1, a2 uint64, lastHint hexutil.Bytes, preimageKey [32]byte, preimageOffset uint64, oracle mipsevm64.PreimageOracle, memory *memory.Memory, memTracker MemTracker, stdOut, stdErr io.Writer) (v0, v1 uint64, newLastHint hexutil.Bytes, newPreimageKey common.Hash, newPreimageOffset uint64) {
	// args: a0 = fd, a1 = addr, a2 = count
...
func HandleSyscallUpdates(cpu *mipsevm64.CpuScalars, registers *[32]uint64, v0, v1 uint64) {
	registers[2] = v0
	registers[7] = v1
