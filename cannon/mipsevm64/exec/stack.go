...
func NewStackTracker(state mipsevm64.FPVMState, meta *program.Metadata) (*StackTrackerImpl, error) {
	if meta == nil {
...
func NewStackTrackerUnsafe(state mipsevm64.FPVMState, meta *program.Metadata) *StackTrackerImpl {
