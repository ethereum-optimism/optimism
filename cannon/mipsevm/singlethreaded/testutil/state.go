...
func (m *StateMutatorSingleThreaded) Randomize(randSeed int64) {
	...
	m.state.PreimageOffset = r.Uint64()
	m.state.Cpu.PC = pc
	m.state.Cpu.NextPC = pc + 4
	m.state.Cpu.HI = r.Uint64()
	m.state.Cpu.LO = r.Uint64()
	m.state.Heap = r.Uint64()
	m.state.Step = step
...
func (m *StateMutatorSingleThreaded) SetPC(val uint64) {
	m.state.Cpu.PC = val
}

func (m *StateMutatorSingleThreaded) SetNextPC(val uint64) {
	m.state.Cpu.NextPC = val
}

func (m *StateMutatorSingleThreaded) SetHI(val uint64) {
	m.state.Cpu.HI = val
}

func (m *StateMutatorSingleThreaded) SetLO(val uint64) {
	m.state.Cpu.LO = val
}

func (m *StateMutatorSingleThreaded) SetHeap(val uint64) {
	m.state.Heap = val
}
...
func (m *StateMutatorSingleThreaded) SetPreimageOffset(val uint64) {
