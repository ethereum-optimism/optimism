...
func NewExpectedMTState(fromState *multithreaded.State) *ExpectedMTState {
	...
	expectedThreads := make(map[uint64]*ExpectedThreadState)
...
func (e *ExpectedMTState) Thread(threadId uint64) *ExpectedThreadState {
