...
func RandomThread(randSeed int64) *multithreaded.ThreadState {
	...
	thread.Cpu.HI = r.Uint64()
	thread.Cpu.LO = r.Uint64()
...
func FindNextThreadExcluding(state *multithreaded.State, threadId uint64) *multithreaded.ThreadState {
	return FindNextThreadFiltered(state, func(t *multithreaded.ThreadState) bool {
		return t.ThreadId != threadId
	})
}

func FindThread(state *multithreaded.State, threadId uint64) *multithreaded.ThreadState {
