...
import (
	...
	mipsevm32 "github.com/ethereum-optimism/optimism/cannon/mipsevm32"
...
type State struct {
	...
	Cpu mipsevm32.CpuScalars `json:"cpu"`
...
var _ mipsevm32.FPVMState = (*State)(nil)

func CreateEmptyState() *State {
	return &State{
		Cpu: mipsevm32.CpuScalars{
			PC:     0,
			NextPC: 4,
			LO:     0,
			HI:     0,
