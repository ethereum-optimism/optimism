...
type VMFactory[T mipsevm32.FPVMState] func(state T, po mipsevm32.PreimageOracle, stdOut, stdErr io.Writer, log log.Logger) mipsevm32.FPVM
type StateFactory[T mipsevm32.FPVMState] func() T

func RunVMTests_OpenMips[T mipsevm32.FPVMState](t *testing.T, stateFactory StateFactory[T], vmFactory VMFactory[T], excludedTests ...string) {
...
func RunVMTest_Hello[T mipsevm32.FPVMState](t *testing.T, initState program.CreateInitialFPVMState[T], vmFactory VMFactory[T], doPatchGo bool) {
	state := LoadELFProgram(t, "../../testdata/example32/bin/hello.elf", initState, doPatchGo)
...
func RunVMTest_Claim[T mipsevm32.FPVMState](t *testing.T, initState program.CreateInitialFPVMState[T], vmFactory VMFactory[T], doPatchGo bool) {
	state := LoadELFProgram(t, "../../testdata/example32/bin/claim.elf", initState, doPatchGo)
