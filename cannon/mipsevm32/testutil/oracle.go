...
var _ mipsevm32.PreimageOracle = (*TestOracle)(nil)
...
func ClaimTestOracle(t *testing.T) (po mipsevm32.PreimageOracle, stdOut string, stdErr string) {
	s := uint64(1000)
	a := uint64(3)
	b := uint64(4)
...
func SelectOracleFixture(t *testing.T, programName string) mipsevm32.PreimageOracle {
