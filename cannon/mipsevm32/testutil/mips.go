...
import (
	...
	mipsevm "github.com/ethereum-optimism/optimism/cannon/mipsevm32"
...
func EncodePreimageOracleInput(t *testing.T, wit *run.StepWitness, localContext run.LocalContext, localOracle mipsevm.PreimageOracle, oracle *foundry.Artifact) ([]byte, error) {
