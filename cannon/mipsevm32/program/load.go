...
type CreateInitialFPVMState[T mipsevm32.FPVMState] func(pc, heapStart uint32) T

func LoadELF[T mipsevm32.FPVMState](f *elf.File, initState CreateInitialFPVMState[T]) (T, error) {
	var empty T
