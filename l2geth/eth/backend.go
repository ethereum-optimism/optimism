...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	log.Info("Backend Config", "max-calldata-size", config.Rollup.MaxCallDataSize, "gas-limit", config.Rollup.GasLimit, "is-verifier", config.Rollup.IsVerifier, "using-ovm", vm.UsingOVM, "dataprice", config.Rollup.DataPrice)
	...
	rollupGpo := gasprice.NewRollupOracle(config.Rollup.DataPrice)
