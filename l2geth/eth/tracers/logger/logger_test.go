...
func TestStoreCapture(t *testing.T) {
	var (
		...
		env      = vm.NewEVM(vm.Context{}, &dummyStatedb{}, params.TestChainConfig, vm.Config{Debug: true, Tracer: logger})
...
// logs bloat and confusion. See https://github.com/ethereum-optimism/optimism/l2geth/issues/24487
