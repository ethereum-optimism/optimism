...
func NewTraceProvider(ctx context.Context, logger log.Logger, rollupRpc string, gameDepth types.PositionDepth, prestateBlock, poststateBlock uint64) (*OutputTraceProvider, error) {
...
func NewTraceProviderFromInputs(logger log.Logger, prestateProvider types.PrestateProvider, rollupClient OutputRollupClient, gameDepth types.PositionDepth, prestateBlock, poststateBlock uint64) *OutputTraceProvider {
