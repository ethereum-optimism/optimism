...
func TestProviderCache(t *testing.T) {
	...
	depth := types.PositionDepth(6)
	var createdProvider types.TraceProvider
	creator := func(ctx context.Context, localContext common.Hash, depth types.PositionDepth, agreed contracts.Proposal, claimed contracts.Proposal) (types.TraceProvider, error) {
