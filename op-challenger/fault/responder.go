...
// LoadOracleData loads the preimage oracle data into the onchain preimage
// oracle contract.
func (r *faultResponder) LoadOracleData(ctx context.Context, data types.PreimageOracleData) error {
	var txData []byte
	var err error
	if data.IsLocal {
