...
<Steps>
  ...
  <Step title="Try the Starter Kit">
    Get hands-on experience with our [SuperchainERC20 starter kit](/app-developers/quickstarts/starter-kit)
  </Step>
...
*   [Compatible Tokens Guide](/app-developers/reference/tokens/compatible-tokens) - Learn about SuperchainERC20 tokens
