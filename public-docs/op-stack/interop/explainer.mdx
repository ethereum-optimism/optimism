...
*   ****: the [SuperchainERC20 superchain-erc20] turns message passing into asset transfer between chains in the interop set. Learn more about how the SuperchainERC20 token standard enables asset interoperability in the Superchain [here](/op-stack/interop/superchain-erc20)
...
*   Build a [revolutionary app](/app-developers/quickstarts/starter-kit) that uses multiple blockchains within the OP Stack ecosystem
*   Deploy a [SuperchainERC20](/op-stack/interop/superchain-erc20) on OP Stack chains
