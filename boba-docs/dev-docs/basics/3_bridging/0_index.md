...
Although Boba Network is an L2 (and therefore fundamentally connected to the L1 (Ethereum)), it's also a separate blockchain system. App developers commonly need to move data and assets between Boba Network and Ethereum. We call the process of moving data and assets between the two networks "bridging".
...
To bridge BOBA tokens between Ethereum and BNB, you can use our [L1 to L1 bridge](./boba-token-bridge) powered by [LayerZero Protocol](https://layerzero.network).
