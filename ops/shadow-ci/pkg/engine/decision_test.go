...
func TestDecisionEngine_PathBased(t *testing.T) {
	...
	de := NewDecisionEngine(scoping, model.PlacementConfig{DefaultStage: model.StagePR}, nil, affected, nil, nil)
...
func TestDecisionEngine_StageFiltering(t *testing.T) {
	...
	t.Run("PR stage skips post_merge categories", func(t *testing.T) {
		de := NewDecisionEngine(scoping, placement, nil, affected, nil, nil)
