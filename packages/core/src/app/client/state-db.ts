...
export class DefaultStateDB implements StateDB {
  async getVerifiedStateUpdates(start: BigNum, end: BigNum): Promise<VerifiedStateUpdate[]> {
    throw Error("DefaultStateDB.getVerifiedStateUpdates is not implemented.")
  }

  async putVerifiedStateUpdate(verifiedStateUpdate: VerifiedStateUpdate): Promise<void> {
