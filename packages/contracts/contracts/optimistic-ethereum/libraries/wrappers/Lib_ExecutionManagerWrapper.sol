...
library Lib_ExecutionManagerWrapper {
    ...
    returns (address, bytes memory)
  {
    bytes memory returndata =
      _callWrapperContract(
        abi.encodeWithSignature('ovmCREATE(bytes)', _bytecode)
      );
   ...
   */
  function ovmGETNONCE() internal returns (uint256) {
    bytes memory returndata =
      _callWrapperContract(abi.encodeWithSignature('ovmGETNONCE()'));
   ...
   */
  function ovmINCREMENTNONCE() internal {
    _callWrapperContract(abi.encodeWithSignature('ovmINCREMENTNONCE()'));
  }
   ...
   */
  function ovmL1TXORIGIN() internal returns (address) {
    bytes memory returndata =
      _callWrapperContract(abi.encodeWithSignature('ovmL1TXORIGIN()'));
   ...
   */
  function ovmCHAINID() internal returns (uint256) {
    bytes memory returndata =
      _callWrapperContract(abi.encodeWithSignature('ovmCHAINID()'));
   ...
   */
  function ovmADDRESS() internal returns (address) {
    bytes memory returndata =
      _callWrapperContract(abi.encodeWithSignature('ovmADDRESS()'));
   ...
   */
  function ovmBALANCE(address _address) internal returns (uint256) {
    bytes memory returndata =
      _callWrapperContract(
        abi.encodeWithSignature('ovmBALANCE(address)', _address)
      );
   ...
   */
  function ovmCALLVALUE() internal returns (uint256) {
    bytes memory returndata =
      _callWrapperContract(abi.encodeWithSignature('ovmCALLVALUE()'));
   ...
   */
  function ovmSETCODE(address _address, bytes memory _code) internal {
    _callWrapperContract(
      abi.encodeWithSignature('ovmSETCODE(address,bytes)', _address, _code)
    );
  }
   ...
   */
  function _callWrapperContract(bytes memory _calldata)
    private
