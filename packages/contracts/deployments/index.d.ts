...
export declare const getL1ContractData: (network: 'goerli' | 'kovan' | 'mainnet') => {
    Lib_L1AddressManager: any;
    OVM_CanonicalTransactionChain: any;
    OVM_ExecutionManager: any;
    OVM_FraudVerifier: any;
    OVM_L1CrossDomainMessenger: any;
    OVM_L1ETHGateway: any;
    OVM_L1MultiMessageRelayer: any;
    OVM_SafetyChecker: any;
    OVM_StateCommitmentChain: any;
    OVM_StateManagerFactory: any;
    OVM_StateTransitionerFactory: any;
    Proxy__OVM_L1CrossDomainMessenger: any;
    Proxy__OVM_L1ETHGateway: any;
    mockOVM_BondManager: any;
};
