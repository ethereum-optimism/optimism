...
task('whitelist')
  ...
  .addOptionalParam(
    'addressPath',
    'Path to a file containing the list of addresses to whitelist',
    undefined,
    types.string
  )
  .addOptionalParam(
    'whitelistMode',
    '"enable" if you want to whitelist the address, "disable" if you want to remove the address from the whitelist',
    'enable',
    types.string
  )
  .addOptionalParam(
    'transactionGasPrice',
    'Gas price to use for the whitelist transaction',
    undefined,
    types.int
  )
  .addOptionalParam(
