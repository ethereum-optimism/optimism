...
contract ChugSplashProxy {
    ...
    modifier onlyWhenNotPaused() {
        ...
        if (success && returndata.length == 32) {
            ...
            require(ret == 0, "ChugSplashProxy: system is currently being upgraded");
        }
    ...
    function setCode(bytes memory _code) public proxyCallIfNotOwner {
        ...
        require(
            ...
            "ChugSplashProxy: code was not correctly deployed."
        );
    ...
    function _doProxyCall() internal onlyWhenNotPaused {
        ...
        require(implementation != address(0), "ChugSplashProxy: implementation is not set yet");
