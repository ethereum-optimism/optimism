...
interface L1StandardBridgeInterface extends ethers.utils.Interface {
  functions: {
...
export class L1StandardBridge extends BaseContract {
  ...
  callStatic: {
    ...
    initialize(_messenger: string, overrides?: CallOverrides): Promise<void>;
