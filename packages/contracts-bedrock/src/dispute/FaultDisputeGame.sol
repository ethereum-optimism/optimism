...
contract FaultDisputeGameN is IFaultDisputeGame, Clone, ISemver {
    ////////////////////////////////////////////////////////////////
    //                         State Vars                         //
    ////////////////////////////////////////////////////////////////
    ...
    function step(uint256 _claimIndex, uint256 _attackBranch, bytes calldata _stateData, bytes calldata _proof) external {
    ...
    function move(uint256 _challengeIndex, Claim _claim, uint256 _attackBranch) public payable {
        // For N = 2 (bisec),
    ...
    function attackAt(
        ...
        move(_parentIndex, _claim, _attackBranch);
    }
