...
contract OPContractsManagerStandardValidator is ISemver {
        ...
        returns (string memory)
    {
        ...
        // TODO: Once ZK is mandatory (not per-chain opt-in) and ZK non-super mode is removed, remove this
        // early return so chains without ZKDisputeGame registered fail validation. Companion to the
        // ZKDG-NOSHAPE TODO in StandardValidatorUtils.sol.
        IDisputeGameFactory _factory = IDisputeGameFactory(_sysCfg.disputeGameFactory());
