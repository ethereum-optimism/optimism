...
contract OPContractsManager is ISemver, Initializable {
    ...
    mapping(uint256 => ISystemConfigV160) public systemConfigs;
    ...
    function deploy(DeployInput calldata _input) external returns (DeployOutput memory) {
        ...
        output.systemConfigProxy = ISystemConfigV160(deployProxy(l2ChainId, output.opChainProxyAdmin, "SystemConfig"));
