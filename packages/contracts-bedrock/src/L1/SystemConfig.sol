...
contract SystemConfig is OwnableUpgradeable, ISemver {
    ...
    /// @notice Storage slot that the DisputeGameFactory address is stored at.
    bytes32 public constant DISPUTE_GAME_FACTORY_SLOT = bytes32(uint256(keccak256("systemconfig.disputegamefactory")) - 1);
