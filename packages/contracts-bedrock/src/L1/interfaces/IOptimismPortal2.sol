...
interface IOptimismPortal2 is IInitializable, IResourceMetering, ISemverPure {
    ...
    function provenWithdrawals(
        ...
        external
        view
        returns (IDisputeGame disputeGameProxy, uint64 timestamp); // nosemgrep: sol-style-input-arg-fmt
