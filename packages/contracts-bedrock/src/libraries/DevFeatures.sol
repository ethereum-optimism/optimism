...
library DevFeatures {
    ...
    /// @notice The feature that enables L2 interop predeploy upgrades in L2CM.
    bytes32 public constant L2_INTEROP = bytes32(0x0000000000000000000000000000000000000000000000000000000001000000);
