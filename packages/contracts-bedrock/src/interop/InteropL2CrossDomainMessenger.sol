...
import { Hashing } from "src/libraries/Encoding.sol";
...
contract InteropL2CrossDomainMessenger is ISemver {
        ...
        payable
    {
        ...
        if (_destination == Constants.ETH_MAINNET_ID) {
        ...
        payable
    {
        ...
        bytes32 msgHash =
            Hashing.hashCrossDomainMessageV2(_nonce, _source, sourceChainID(), _sender, _target, _value, _minGasLimit, _message);
