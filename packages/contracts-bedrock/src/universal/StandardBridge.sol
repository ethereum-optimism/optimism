...
/// @title StandardBridgeBase
/// @notice StandardBridgeBase is the root contract that maintains a shared storage layout
///         between the StandardBridge, ETHStandardBridge, and ERC20StandardBridge.
abstract contract StandardBridgeBase is Initializable {
...
/// @title ETHStandardBridge
/// @notice ETHStandardBridge is the base contract for bridging ETH
abstract contract ETHStandardBridge is StandardBridgeBase {
...
/// @title ERC20StandardBridge
/// @notice ERC20StandardBridge is the base contract for bridging ERC20 tokens.
abstract contract ERC20StandardBridge is StandardBridgeBase {
...
/// @notice StandardBridge is a base contract for the L1 and L2 standard ETH & ERC20 bridges.
///         It handles the core bridging logic, including escrowing tokens that are native to
