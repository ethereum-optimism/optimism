...
contract L1Block is ISemver {
    ...
    /// @notice Ensures daFootprintGasScalar goes in the next storage slot.
    /// Otherwise bit-twiddling would be necessary in setL1BlockValuesJovian.
    uint160 private spacer;
    ...
    function _setL1BlockValuesJovian() internal {
        ...
        assembly {
            ...
            sstore(daFootprintGasScalar.slot, shr(240, calldataload(176)))
        }
    }
}
