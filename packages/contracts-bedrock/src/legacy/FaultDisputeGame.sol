...
import { ILegacyFaultDisputeGame } from "src/legacy/interfaces/IFaultDisputeGame.sol";
...
/// @title LegacyFaultDisputeGame
/// @notice An implementation of the `ILegacyFaultDisputeGame` interface.
/// @dev This version of the fault dispute game was released in the fault proof alpha, and features no bonds nor output
///      bisection.
