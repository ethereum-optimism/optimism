...
library Config {
    ...
    /// @notice Returns true if the development feature l2_interop is enabled.
    function devFeatureL2Interop() internal view returns (bool) {
        return vm.envOr("DEV_FEATURE__L2_INTEROP", false);
    }
