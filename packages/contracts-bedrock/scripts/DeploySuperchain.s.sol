...
contract DeploySuperchainOutput is BaseDeployIO {
    ...
    function set(bytes4 sel, address _address) public {
        ...
        if (sel == this.superchainProxyAdmin.selector) _superchainProxyAdmin = IProxyAdmin(_address);
        else if (sel == this.superchainConfigImpl.selector) _superchainConfigImpl = ISuperchainConfig(_address);
        else if (sel == this.superchainConfigProxy.selector) _superchainConfigProxy = ISuperchainConfig(_address);
        else if (sel == this.protocolVersionsImpl.selector) _protocolVersionsImpl = IProtocolVersions(_address);
        else if (sel == this.protocolVersionsProxy.selector) _protocolVersionsProxy = IProtocolVersions(_address);
...
contract DeploySuperchain is Script {
    ...
    function deploySuperchainProxyAdmin(DeploySuperchainInput, DeploySuperchainOutput _dso) public {
        ...
        IProxyAdmin superchainProxyAdmin = IProxyAdmin(DeployUtils.deploy("ProxyAdmin", abi.encode(msg.sender)));
    ...
    function deploySuperchainImplementationContracts(DeploySuperchainInput, DeploySuperchainOutput _dso) public {
        ...
        ISuperchainConfig superchainConfigImpl = ISuperchainConfig(DeployUtils.deploy("SuperchainConfig", hex""));
        IProtocolVersions protocolVersionsImpl = IProtocolVersions(DeployUtils.deploy("ProtocolVersions", hex""));
        vm.stopBroadcast();
    ...
    function deployAndInitializeSuperchainConfig(DeploySuperchainInput _dsi, DeploySuperchainOutput _dso) public {
        ...
        ISuperchainConfig superchainConfigProxy =
            ISuperchainConfig(address(DeployUtils.deploy("Proxy", abi.encode(superchainProxyAdmin))));
    ...
    function deployAndInitializeProtocolVersions(DeploySuperchainInput _dsi, DeploySuperchainOutput _dso) public {
        ...
        IProtocolVersions protocolVersionsProxy =
            IProtocolVersions(address(DeployUtils.deploy("Proxy", abi.encode(superchainProxyAdmin))));
        superchainProxyAdmin.upgradeAndCall(
