...
contract L1BlockInteropIsDeposit_Test is L1BlockInteropTest {
    ...
    function test_isDeposit_succeeds() external {
        ...
        _l1BlockInterop().setL1BlockValuesIsthmus();
...
contract L1BlockInteropSetL1BlockValuesIsthmus_Test is L1BlockInteropTest {
        ...
        external
    {
        ...
        (bool success,) = address(l1Block).call(
            abi.encodePacked(L1BlockInterop.setL1BlockValuesIsthmus.selector, setValuesEcotoneCalldata)
        );
