...
contract SaferSafesCompatibilityTest is SafeCompatibilityTest {
    ...
    function test_strict_fullConfiguration() public {
    ...
    function test_verbose_enableBoth() public {
    ...
    function test_verbose_fullConfiguration() public {
    ...
    function test_verbose_configurationValidation() public {
    ...
    function _testEnableModule(SafeVersion memory safeVersion) external {
        ...
        bytes memory data = abi.encodeWithSignature("enableModule(address)", address(saferSafes));
    ...
    function _testSetGuard(SafeVersion memory safeVersion) external {
        ...
        bytes memory data = abi.encodeWithSignature("setGuard(address)", address(saferSafes));
    ...
    function _testEnableModuleAndGuard(SafeVersion memory safeVersion) external {
        // Enable module
        bytes memory moduleData = abi.encodeWithSignature("enableModule(address)", address(saferSafes));
        _executeSafeTransaction(safeVersion.safe, address(safeVersion.safe), 0, moduleData, Enum.Operation.Call);

        // Set guard
        bytes memory guardData = abi.encodeWithSignature("setGuard(address)", address(saferSafes));
    ...
    function _testFullConfiguration(SafeVersion memory safeVersion) external {
        ...
        bytes memory enableModuleData = abi.encodeWithSignature("enableModule(address)", address(saferSafes));
        ...
        bytes memory setGuardData = abi.encodeWithSignature("setGuard(address)", address(saferSafes));
        ...
        bytes memory configureModuleData =
            abi.encodeWithSignature("configureLivenessModule((uint256,address))", moduleConfig);
        ...
        bytes memory configureGuardData = abi.encodeWithSignature("configureTimelockGuard(uint256)", TIMELOCK_DELAY);
