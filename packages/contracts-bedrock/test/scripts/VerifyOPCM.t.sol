...
contract VerifyOPCM_TestInit is DeployOPChain_TestBase {
    ...
    /// @notice Sets up environment variables for OPCM verification
...
contract VerifyOPCM_Run_Test is VerifyOPCM_TestInit {
    ...
    /// @dev This test is adapted for v2.0.0 where contractsContainer concept doesn't exist yet
    function test_verifyContractsContainerConsistency_succeeds() public {
        ...
        // In v2.0.0, contractsContainer verification is skipped since the concept doesn't exist
        // This test should succeed with no verification done
