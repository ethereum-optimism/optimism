...
contract L2Genesis_Test is Test, L2Genesis {
    ...
    /// @notice Arbitrary address.
    // L2Genesis internal l2Genesis = L2Genesis(0x7fa9385Be102aC3Eac297483DD6233d62B000000);
    // function test_dealEthToPrecompiles() external {
    //     // dealEthToPrecompiles();
    //     // for (uint256 i; i < L2GenesisHelpers.PRECOMPILE_COUNT; i++) {
    //     //     _checkPrecompile(address(uint160(i)));
    //     // }
    // }

    // function test_setPredeployProxies() external {
    //     // vm.startStateDiffRecording();
    //     // l2Genesis.setPredeployProxies();

    //     // // for (uint256 i = 0; i < L2GenesisHelpers.PROXY_COUNT; i++) {
    //     // uint160 prefix = uint160(0x420) << 148;
    //     // for (uint256 i = 0; i < 1; i++) {
    //     //     Proxy proxy = Proxy(payable(address(prefix | uint160(i))));
    ...
    //     //     if (
    //     //         accountAccesses[i].account != 0x7109709ECfa91a80626fF3989D68f67F5b1DD12D
    //     //         && accountAccesses[i].account != address(l2Genesis)
    //     //     ) {
    //     //         console.log("account", accountAccesses[i].account);
    //     //         // _checkPredeployProxy(accountAccesses[i]);

    //     //         console.log("length", accountAccesses[i].storageAccesses.length);
    //     //         for (uint256 j; j < accountAccesses[i].storageAccesses.length; j++) {
    //     //             console.logBytes32(accountAccesses[i].storageAccesses[j].slot);
    //     //             console.logBytes32(accountAccesses[i].storageAccesses[j].newValue);
    //     //         }
    //     //     }
    //     // }
    // }
