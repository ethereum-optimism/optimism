...
contract LegacyMintableERC20_SupportsInterface_Test is LegacyMintableERC20_TestInit {
    ...
    function testFuzz_supportsInterface_unsupportedInterface_succeeds(bytes4 _interfaceId) public view {
        bytes4 erc165Interface = bytes4(keccak256("supportsInterface(bytes4)"));
        bytes4 legacyInterface = ILegacyMintableERC20.l1Token.selector ^ ILegacyMintableERC20.mint.selector
            ^ ILegacyMintableERC20.burn.selector;
        vm.assume(_interfaceId != erc165Interface && _interfaceId != legacyInterface);
...
contract LegacyMintableERC20_Mint_Test is LegacyMintableERC20_TestInit {
    ...
    /// @notice Tests that the mint function reverts when called by a non-bridge address.
