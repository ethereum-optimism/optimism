...
contract OPContractsManagerV2_Deploy_Test is OPContractsManagerV2_TestInit {
        ...
        public
    {
        ...
        _cfg.resourceConfig.maxResourceLimit -= _cfg.resourceConfig.maxResourceLimit
        % _cfg.resourceConfig.elasticityMultiplier;
        ...
        _cfg.disputeGameConfigs[permissionedIndex].gameArgs = superRoot
            ? abi.encode(
                IOPContractsManagerUtils.SuperPermissionedDisputeGameConfig({ proposer: _permissioned.proposer })
            )
