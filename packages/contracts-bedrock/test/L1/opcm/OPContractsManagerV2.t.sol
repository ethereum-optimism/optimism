...
contract OPContractsManagerV2_Migrate_Test is OPContractsManagerV2_TestInit {
    ...
    function test_setInteropDisputeGames_succeeds() public {
        ...
        assertTrue(
            address(sharedDgf.gameImpls(GameTypes.SUPER_PERMISSIONED_CANNON)) != address(0), "source not registered"
        );
        ...
        assertEq(address(sharedDgf.gameImpls(GameTypes.SUPER_PERMISSIONED_CANNON)), address(0), "source not cleared");
