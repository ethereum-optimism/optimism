...
/// @title L1ERC721Bridge_TestERC721
/// @notice Test ERC721 contract.
contract L1ERC721Bridge_TestERC721 is ERC721 {
...
/// @notice Test contract for L1ERC721Bridge.
contract L1ERC721Bridge_TestInit is CommonTest {
    L1ERC721Bridge_TestERC721 internal localToken;
    L1ERC721Bridge_TestERC721 internal remoteToken;
    ...
    function setUp() public virtual override {
        ...
        localToken = new L1ERC721Bridge_TestERC721();
        remoteToken = new L1ERC721Bridge_TestERC721();
...
/// @notice Test contract for L1ERC721Bridge constructor.
contract L1ERC721Bridge_Constructor_Test is L1ERC721Bridge_TestInit {
    ...
    function test_constructor_succeeds() public virtual {
        ...
        // The constructor now uses _disableInitializers, whereas OP Mainnet has the other bridge
        // in storage
...
contract L1ERC721Bridge_finalizeBridgeERC721_Test is L1ERC721Bridge_TestInit {
    ...
    /// @notice Tests that the ERC721 bridge finalize reverts when not called
    ...
    /// @notice Tests that the ERC721 bridge finalize reverts when the local token
    ...
    /// @notice Tests that the ERC721 bridge finalize reverts when the remote token
