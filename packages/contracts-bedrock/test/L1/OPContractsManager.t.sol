...
contract OPContractsManager_AddGameType_Test is OPContractsManager_TestInit {
        ...
        view
    {
        ...
        // Note: absolutePrestate, vm, and anchorStateRegistry cannot be checked on the implementation
        // contract since they are provided via CWIA (Clone With Immutable Args) when instances are created
...
contract OPContractsManager_UpdatePrestate_Test is OPContractsManager_TestInit {
    ...
    function test_updatePrestate_pdgOnlyWithValidInput_succeeds() public {
        ...
        // Note: absolutePrestate cannot be checked on the implementation
        // contract since it is provided via CWIA (Clone With Immutable Args) when instances are created
