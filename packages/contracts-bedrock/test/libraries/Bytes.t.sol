...
contract Bytes_slice_Test is Test {
    ...
    function test_slice_fromZeroIdx_works() public view {
    ...
    function test_slice_fromNonZeroIdx_works() public view {
        bytes memory input = hex"11223344556677889900";
    ...
    function test_slice_acrossWords_works() public view {
        bytes memory input =
    ...
    function test_slice_acrossMultipleWords_works() public view {
        bytes memory input =
...
contract Bytes_toNibbles_Test is Test {
    ...
    function test_toNibbles_expectedResult5Bytes_works() public view {
    ...
    function test_toNibbles_expectedResult128Bytes_works() public view {
        bytes memory input =
    ...
    ///         length array.
    function test_toNibbles_zeroLengthInput_works() public view {
...
contract Bytes_equal_Test is Test {
    ...
    function testFuzz_equal_notEqual_works(bytes memory _a, bytes memory _b) public view {
    ...
    function testDiff_equal_works(bytes memory _a, bytes memory _b) public view {
