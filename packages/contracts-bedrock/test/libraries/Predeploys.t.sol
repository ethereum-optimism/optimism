...
abstract contract Predeploys_TestInit is CommonTest {
    ...
    function _test_predeploys(Fork _fork, bool _isCustomGasToken) internal {
        uint256 count = 2048;
        ...
        for (uint256 i = 0; i < count; i++) {
            ...
            bool isPredeploy =
                Predeploys.isSupportedPredeploy(addr, uint256(_fork), _isCustomGasToken, devFeatureBitmap);
