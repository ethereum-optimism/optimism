...
contract DevFeatures_isEnabled_Test is Test {
    ...
    function test_isDevFeatureEnabled_checkSingleFeatureExactMatch_true() public pure {
    ...
    function test_isDevFeatureEnabled_checkSingleFeatureAgainstSuperset_true() public pure {
    ...
    function test_isDevFeatureEnabled_checkSingleFeatureAgainstAll_true() public pure {
    ...
    function test_isDevFeatureEnabled_checkSingleFeatureAgainstMismatchedBitmap_false() public pure {
    ...
    function test_isDevFeatureEnabled_checkSingleFeatureAgainstEmptyBitmap_false() public pure {
    ...
    function test_isDevFeatureEnabled_checkCombinedFeaturesAgainstExactMatch_true() public pure {
        assertTrue(DevFeatures.isDevFeatureEnabled(FEATURES_AB, FEATURES_AB));
    }

    function test_isDevFeatureEnabled_checkCombinedFeatureAgainstSuperset_true() public pure {
    ...
    function test_isDevFeatureEnabled_checkCombinedFeaturesAgainstSubset_false() public pure {
    ...
    function test_isDevFeatureEnabled_checkCombinedFeaturesAgainstMismatchedBitmap_false() public pure {
    ...
    function test_isDevFeatureEnabled_checkEmptyVsEmpty_false() public pure {
        assertFalse(DevFeatures.isDevFeatureEnabled(EMPTY_FEATURES, EMPTY_FEATURES));
    }

    function test_isDevFeatureEnabled_checkAllVsAll_true() public pure {
        assertTrue(DevFeatures.isDevFeatureEnabled(ALL_FEATURES, ALL_FEATURES));
    }

    function test_isDevFeatureEnabled_checkEmptyAgainstAll_false() public pure {
        assertFalse(DevFeatures.isDevFeatureEnabled(ALL_FEATURES, EMPTY_FEATURES));
    }

    function test_isDevFeatureEnabled_checkAllAgainstEmpty_false() public pure {
