...
1. Generate the hardhat deploy artifacts with `forge script -vvv scripts/deploy/Deploy.s.sol:Deploy --sig 'sync()' --rpc-url $ETH_RPC_URL --broadcast --private-key $PRIVATE_KEY`
