...
**Test:** [`OptimismPortal2.t.sol#L162`](../test/invariants/OptimismPortal2.t.sol#L162)

All deposits, barring creation transactions and transactions sent to `address(0)`, should always succeed. 

## `finalizeWithdrawalTransaction` should revert if the proof maturity period has not elapsed.
**Test:** [`OptimismPortal2.t.sol#L184`](../test/invariants/OptimismPortal2.t.sol#L184)
...
**Test:** [`OptimismPortal2.t.sol#L213`](../test/invariants/OptimismPortal2.t.sol#L213)
