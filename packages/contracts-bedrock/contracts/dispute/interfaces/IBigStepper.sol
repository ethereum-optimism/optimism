...
interface IBigStepper {
    ...
    /// @notice Returns the preimage oracle used by the VM to fetch and store preimages.
    /// @return preimageOracle_ The preimage oracle.
    function oracle() external view returns (IPreimageOracle preimageOracle_);
}
