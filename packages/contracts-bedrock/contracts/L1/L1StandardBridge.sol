 ...
 *         contract. If the ERC20 token is native to L2, it will be burnt. After the Bedrock
 *         upgrade, ETH is no longer stored within this contract and is instead transferred to and
 *         escrowed within the OptimismPortal contract.
