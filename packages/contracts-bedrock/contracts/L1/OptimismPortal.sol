...
contract OptimismPortal is Initializable, ResourceMetering, Semver {
    ...
    function finalizeWithdrawalTransaction(
        ...
        // Trigger the call to the target contract. We use MemorySafeCall because we
        // don't care about the returndata and we don't want target contracts to
        // be able to force this call to run out of gas via a returndata bomb.
        bool success = MemorySafeCall.call(_tx.target, _tx.gasLimit, _tx.value, _tx.data);
