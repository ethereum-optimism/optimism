    ...
    ReentrancyGuardUpgradeable
{
    ...
    /**
     * @notice Mapping of message hashes to boolean relay success values.
     */
    ...
    function xDomainMessageSender() external view returns (address) {
        require(
            ...
            "CrossDomainMessenger: no message is currently being executed"
        );
    ...
    function relayMessage(
        ...
        if (_isFromOtherMessenger()) {
            // Should never happen.
            require(
                msg.value == _value,
                "CrossDomainMessenger: given value does not match expected value"
            );
        } else {
            ...
            require(
                ...
                "CrossDomainMessenger: message has not been received before and cannot be replayed"
            );
        }
        ...
        require(
            ...
            "CrossDomainMessenger: cannot send messages to blocked system addresses"
        );
     ...
     *         being deployed.
     */
    function _isFromOtherMessenger() internal view virtual returns (bool);
