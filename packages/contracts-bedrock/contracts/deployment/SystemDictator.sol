...
contract SystemDictator is OwnableUpgradeable {
    ...
    function step5() external onlyOwner step(5) {
        ...
        try L1CrossDomainMessenger(config.proxyAddressConfig.l1CrossDomainMessengerProxy).initialize(address(this)) {
    ...
    function finalize() external onlyOwner {
        ...
        L1CrossDomainMessenger(config.proxyAddressConfig.l1CrossDomainMessengerProxy).transferOwnership(
