...
1. Before creating a finalized release (i.e. not a release candidate), you MUST have the contracts deployed on Sepolia and Mainnet and work with the EVM Safety team to perform the [Contracts Release Checklist](https://www.notion.so/oplabs/Contracts-Release-Checklists-216f153ee16280fda3c2f141c062f974?source=copy_link)
