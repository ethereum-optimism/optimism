...
export interface ICrossChainProvider {
  ...
  /**
   * Name of the network that this provider is attached to.
   */
  network: NetworkName
   ...
   * @param direction Direction to search for messages in. If not provided, will attempt to
   ...
   * @param direction Direction to search for messages in. If not provided, will attempt to find
   * all messages in both directions.
   * @param fromBlock Block to start searching for messages from. If not provided, will start from
   * the first block (block #0).
   * @param toBlock Block to stop searching for messages at. If not provided, will stop at the
