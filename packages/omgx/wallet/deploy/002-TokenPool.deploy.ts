...
const deployFn: DeployFunction = async (hre) => {
    ...
    const L2DepositedERC20 = await hre.deployments.getOrNull('L2DepositedERC20');
    ...
    if(L2DepositedERC20 === undefined){
      console.log(`!!! ${chalk.red('L2TokenPool was not registered because L2DepositedERC20 was not deployed')}`)
    }
    else{
