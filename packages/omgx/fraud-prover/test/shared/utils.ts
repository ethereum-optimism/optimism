...
export const fraudl1Wallet = new Wallet(process.env.FRAUD_PRIVATE_KEY).connect(l1Provider)
export const fraudl2Wallet = new Wallet(process.env.FRAUD_PRIVATE_KEY).connect(l2Provider)
