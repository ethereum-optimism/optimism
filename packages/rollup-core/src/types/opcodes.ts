...
export enum OpcodeTagReason {
  ...
  IS_PUSH_JUMPDEST_MATCH_SUCCESS_LOCATION,
  IS_PUSH_OPCODE_REPLACEMENT_LOCATION,
  IS_JUMP_TO_OPCODE_REPLACEMENT_LOCATION,
  IS_OPCODE_REPLACEMENT_JUMPDEST,
  IS_JUMP_BACK_TO_REPLACED_OPCODE,
  IS_JUMPDEST_OF_REPLACED_OPCODE
}
