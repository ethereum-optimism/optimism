...
const getProvider = (wallet: Wallet): Provider => {
  if (Environment.l1NodeInfuraNetwork() && Environment.l1NodeInfuraProjectId()) {
    log.info(`Connecting to L1 Infura network: ${Environment.l1NodeInfuraNetwork()}`)
    return new InfuraProvider(Environment.l1NodeInfuraNetwork(), Environment.l1NodeInfuraProjectId())
