...
export class MockchainProvider extends JsonRpcProvider {
    ...
    async getBlockWithTransactions(blockNumber: number): Promise<ExtendedBlock> {
    ...
    private _toL2Block(block: BlockWithTransactions): ExtendedBlock {
        return Object.assign(block, {
            queueOriginText: 'sequencer',
            stateRoot: '0x' + '42'.repeat(32)
        })
    }
}
