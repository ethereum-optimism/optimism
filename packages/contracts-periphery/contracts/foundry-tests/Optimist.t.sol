...
contract OptimistTest is Optimist_Initializer {
    ...
    function test_tokenURI_returnsCorrectTokenURI_succeeds() external {
        ...
        assertEq(
            ...
            "https://storageapi.fleek.co/6442819a1b05-bucket/optimist-nft/attributes/0x1d96f2f6bef1202e4ce1ff6dad0c2cb002861d3e.json" //solhint-disable-line max-line-length
        );
    }
