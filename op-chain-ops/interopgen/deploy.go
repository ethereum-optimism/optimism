...
func DeploySuperchainToL1(l1Host *script.Host, opcmScripts *opcm.Scripts, superCfg *SuperchainConfig) (*SuperchainDeployment, error) {
	...
	implementationsDeployment, err := opcmScripts.DeployImplementations.Run(opcm.DeployImplementationsInput{
		...
		"superchainProxyAdmin":            superDeployment.Address("superchainProxyAdmin"),
		"superchainConfigProxy":           superDeployment.Address("superchainConfigProxy"),
	...
	return &SuperchainDeployment{
		Implementations:       NewImplementationsFromDeployImplementationsOutput(implementationsDeployment),
		ProxyAdmin:            superDeployment.Address("superchainProxyAdmin"),
		SuperchainConfig:      superDeployment.Address("superchainConfigImpl"),
		SuperchainConfigProxy: superDeployment.Address("superchainConfigProxy"),
	}, nil
}
