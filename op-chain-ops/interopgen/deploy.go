...
func DeploySuperchainToL1(l1Host *script.Host, opcmScripts *opcm.Scripts, superCfg *SuperchainConfig) (*SuperchainDeployment, error) {
	...
	return &SuperchainDeployment{
		Implementations: Implementations{
			Opcm:                             implementationsDeployment.Opcm,
			OpcmContractsContainer:           implementationsDeployment.OpcmContractsContainer,
			OpcmGameTypeAdder:                implementationsDeployment.OpcmGameTypeAdder,
			OpcmDeployer:                     implementationsDeployment.OpcmDeployer,
			OpcmUpgrader:                     implementationsDeployment.OpcmUpgrader,
			OpcmInteropMigrator:              implementationsDeployment.OpcmInteropMigrator,
			OpcmStandardValidator:            implementationsDeployment.OpcmStandardValidator,
			DelayedWETHImpl:                  implementationsDeployment.DelayedWETHImpl,
			OptimismPortalImpl:               implementationsDeployment.OptimismPortalImpl,
			OptimismPortalInteropImpl:        implementationsDeployment.OptimismPortalInteropImpl,
			ETHLockboxImpl:                   implementationsDeployment.ETHLockboxImpl,
			PreimageOracleSingleton:          implementationsDeployment.PreimageOracleSingleton,
			MipsSingleton:                    implementationsDeployment.MipsSingleton,
			SystemConfigImpl:                 implementationsDeployment.SystemConfigImpl,
			L1CrossDomainMessengerImpl:       implementationsDeployment.L1CrossDomainMessengerImpl,
			L1ERC721BridgeImpl:               implementationsDeployment.L1ERC721BridgeImpl,
			L1StandardBridgeImpl:             implementationsDeployment.L1StandardBridgeImpl,
			OptimismMintableERC20FactoryImpl: implementationsDeployment.OptimismMintableERC20FactoryImpl,
			DisputeGameFactoryImpl:           implementationsDeployment.DisputeGameFactoryImpl,
			AnchorStateRegistryImpl:          implementationsDeployment.AnchorStateRegistryImpl,
			SuperchainConfigImpl:             implementationsDeployment.SuperchainConfigImpl,
			ProtocolVersionsImpl:             implementationsDeployment.ProtocolVersionsImpl,
			FaultDisputeGameV2Impl:           implementationsDeployment.FaultDisputeGameV2Impl,
			PermissionedDisputeGameV2Impl:    implementationsDeployment.PermissionedDisputeGameV2Impl,
		},
