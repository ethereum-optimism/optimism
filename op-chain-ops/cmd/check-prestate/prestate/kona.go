...
// that the kona-client release identified by ref was built against, by reading
// the superchain-registry submodule's pointer from the monorepo tree at that
// tag. If the tag isn't present locally, the function fetches it from origin
// before giving up.
//
