...
[@eth-optimism/viem](../../README.md) / [chains](../README.md) / ink
...
> `readonly` **name**: `"Ink Explorer"` = `'Ink Explorer'`

### blockExplorers.default.url

> `readonly` **url**: `"https://explorer.inkonchain.com"` = `'https://explorer.inkonchain.com'`
...
> `readonly` **address**: `"0x10d7B35078d3baabB96Dd45a9143B94be65b12CD"` = `'0x10d7B35078d3baabB96Dd45a9143B94be65b12CD'`
...
> `readonly` **address**: `"0x69d3Cf86B2Bf1a9e99875B7e2D9B6a84426c171f"` = `'0x69d3Cf86B2Bf1a9e99875B7e2D9B6a84426c171f'`
...
> `readonly` **address**: `"0x661235a238B11191211fa95D4Dd9E423d521E0Be"` = `'0x661235a238B11191211fa95D4Dd9E423d521E0Be'`
...
> `readonly` **address**: `"0x88FF1e5b602916615391F55854588EFcBB7663f0"` = `'0x88FF1e5b602916615391F55854588EFcBB7663f0'`
...
> `readonly` **address**: `"0x5d66C1782664115999C47c9fA5cd031f495D3e4F"` = `'0x5d66C1782664115999C47c9fA5cd031f495D3e4F'`
...
> `readonly` **address**: `"0x62C0a111929fA32ceC2F76aDba54C16aFb6E8364"` = `'0x62C0a111929fA32ceC2F76aDba54C16aFb6E8364'`
...
> `readonly` **http**: readonly [`"https://rpc-gel.inkonchain.com"`]
...
[packages/viem/src/chains/mainnet.ts:387](https://github.com/ethereum-optimism/ecosystem/blob/11bb27f871c202b93ad6dc93c86c82f0c754075f/packages/viem/src/chains/mainnet.ts#L387)
