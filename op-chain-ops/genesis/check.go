...
var (
	...
	ContractStorageCount = map[common.Address]int{
		predeploys.L2CrossDomainMessengerAddr:        1,
		predeploys.L2StandardBridgeAddr:              0,
		predeploys.SequencerFeeVaultAddr:             0,
		predeploys.OptimismMintableERC20FactoryAddr:  0,
		predeploys.L1BlockNumberAddr:                 0,
		predeploys.GasPriceOracleAddr:                0,
		predeploys.L1BlockAddr:                       0,
		predeploys.L2ERC721BridgeAddr:                0,
		predeploys.OptimismMintableERC721FactoryAddr: 0,
		predeploys.ProxyAdminAddr:                    3,
		predeploys.BaseFeeVaultAddr:                  0,
		predeploys.L1FeeVaultAddr:                    0,
	}
)
