...
// 	receipt, err := waitMined(ctx, h.l, h.backend, tx, 50*time.Millisecond, 1)
// 	require.Equal(t, err, context.DeadlineExceeded)
// 	require.Nil(t, receipt)
// }
...
// 	receipt, err := waitMined(ctxt, h.backend, tx, 50*time.Millisecond, numConfs)
// 	require.Equal(t, err, context.DeadlineExceeded)
// 	require.Nil(t, receipt)
...
// 	ctx := context.Background()
// 	receipt, err := WaitMined(ctx, &borkedBackend, tx, 50*time.Millisecond, 1)
// 	require.Nil(t, err)
// 	require.NotNil(t, receipt)
// 	require.Equal(t, receipt.TxHash, txHash)
// }
