...
// upgradeSuperRootGames configures super games without changing the genesis anchor or shared contracts.
func upgradeSuperRootGames(
	t devtest.T,
	keys devkeys.Keys,
	...
	absoluteCannonKonaPrestate := PrestateForGameType(t, gameTypes.SuperCannonKonaGameType)
