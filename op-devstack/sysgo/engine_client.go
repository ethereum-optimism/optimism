...
func (e *engineClient) NewPayloadV2(_ context.Context, data engine.ExecutableData) (engine.PayloadStatusV1, error) {
...
func (e *engineClient) NewPayloadV3(_ context.Context, data engine.ExecutableData, versionedHashes []common.Hash, beaconRoot *common.Hash) (engine.PayloadStatusV1, error) {
	var result engine.PayloadStatusV1
...
func (e *engineClient) NewPayloadV4(_ context.Context, data engine.ExecutableData, versionedHashes []common.Hash, beaconRoot *common.Hash, executionRequests []hexutil.Bytes) (engine.PayloadStatusV1, error) {
	var result engine.PayloadStatusV1
