...
func addGameTypesForRuntime(
	...
	if enabled[gameTypes.SuperCannonKonaGameType] || enabled[gameTypes.ZKDisputeGameType] {
		superrootTime := awaitSuperrootTime(t, l2CL)
		initializeSuperRootAnchor(t, keys, migration, l1ChainID, l1EL,
			getSuperRoot(t, l2CL.UserRPC(), superrootTime), superrootTime, l2Net.ChainID())
	}
