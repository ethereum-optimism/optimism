...
func WithKonaSupervisor(supervisorID stack.SupervisorID, clusterID stack.ClusterID, l1ELID stack.L1ELNodeID, opts ...SupervisorOption) stack.Option[*Orchestrator] {
