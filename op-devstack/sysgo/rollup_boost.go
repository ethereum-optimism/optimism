...
func (r *RollupBoostNode) Start() {
	...
	logOut := logpipe.ToLoggerWithMinLevel(r.logger.New("stream", "stdout"), log.LevelError)
	logErr := logpipe.ToLoggerWithMinLevel(r.logger.New("stream", "stderr"), log.LevelError)
