...
var L2ChainA = First[stack.L2Network]()

// L2ChainB is an alias for the second L2 network.
var L2ChainB = Second[stack.L2Network]()

// L2ChainById returns a matcher for the L2 network with the given ID.
func L2ChainById(id stack.ComponentID) stack.Matcher[stack.L2Network] {
	return byID[stack.L2Network](id)
}
