...
func NewMinimal(t devtest.T) *Minimal {
	...
	out := &Minimal{
		...
		L2Batcher:    dsl.NewL2Batcher(l2.L2Batcher(match.Assume(t, match.FirstL2Batcher)), l2.ChainID()),
		L2EL:         dsl.NewL2ELNode(l2.L2ELNode(match.Assume(t, match.FirstL2EL)), l2.ChainID()),
