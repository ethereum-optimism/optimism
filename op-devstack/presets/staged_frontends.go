...
// NewStagedL2ELFrontend exposes an already-started runtime EL through the
// ordinary devstack DSL without constructing a preset or ancillary services.
...
// NewStagedL2CLFrontend exposes an already-started runtime CL and attaches it
// to the matching staged EL frontend.
