...
func TestE2EBridgeL2CrossDomainMessenger(t *testing.T) {
	...
	_, finalizedReceipt, _, _ := op_e2e.ProveAndFinalizeWithdrawal(t, *testSuite.OpCfg, testSuite.OpSys, "sequencer", testSuite.OpCfg.Secrets.Alice, sentMsgReceipt, &testSuite.OpCfg.DeployConfig.RespectedGameType)
