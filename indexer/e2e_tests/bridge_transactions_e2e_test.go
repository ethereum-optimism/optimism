...
func TestE2EBridgeTransactionsOptimismPortalDeposits(t *testing.T) {
	...
	require.Equal(t, params.Ether, deposit.Tx.Amount.Int64())
...
func TestE2EBridgeTransactionsL2ToL1MessagePasserWithdrawal(t *testing.T) {
	...
	require.Equal(t, big.NewInt(100_000), withdraw.GasLimit.Int64())
	require.Equal(t, params.Ether, withdraw.Tx.Amount.Int64())
