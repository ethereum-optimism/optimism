...
func (_ERC20 *ERC20Transactor) Destroy(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "destroy")
}

// Destroy is a paid mutator transaction binding the contract method 0x83197ef0.
//
// Solidity: function destroy() returns()
func (_ERC20 *ERC20Session) Destroy() (*types.Transaction, error) {
	return _ERC20.Contract.Destroy(&_ERC20.TransactOpts)
}

// Destroy is a paid mutator transaction binding the contract method 0x83197ef0.
//
// Solidity: function destroy() returns()
func (_ERC20 *ERC20TransactorSession) Destroy() (*types.Transaction, error) {
	return _ERC20.Contract.Destroy(&_ERC20.TransactOpts)
}
