...
func TestPureDerive_SingleBatch(t *testing.T) {
	...
	derived, err := PureDerive(cfg, testL1ChainConfig(), testLogger, safeHead, sysConfig, []L1Input{*l1Origin, *l1})
...
func TestPureDerive_EmptyEpoch(t *testing.T) {
	...
	derived, err := PureDerive(cfg, testL1ChainConfig(), testLogger, safeHead, sysConfig, l1Blocks)
	require.NoError(t, err)
...
func TestPureDerive_RejectsPreKarst(t *testing.T) {
	...
	_, err := PureDerive(cfg, testL1ChainConfig(), testLogger, safeHead, sysConfig, nil)
	require.Error(t, err)
...
func TestPureDerive_ValidatesL1BlockRange(t *testing.T) {
	...
	_, err := PureDerive(cfg, testL1ChainConfig(), testLogger, safeHead, sysConfig, l1Blocks)
	require.Error(t, err)
...
func TestPureDerive_EmptyL1Blocks(t *testing.T) {
	...
	derived, err := PureDerive(cfg, testL1ChainConfig(), testLogger, safeHead, sysConfig, nil)
	require.NoError(t, err)
