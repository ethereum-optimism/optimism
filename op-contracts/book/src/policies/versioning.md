...
The [OPCM](https://github.com/ethereum-optimism/optimism/blob/develop/op-contracts/src/L1/opcm/OPContractsManagerV2.sol) is the contract that manages the deployment of all contracts on L1.

The `OPCM` is the source of truth for the contracts that belong in a release, available as on-chain addresses by querying the [`implementations()`](https://github.com/ethereum-optimism/optimism/blob/develop/op-contracts/src/L1/opcm/OPContractsManagerV2.sol) function.
