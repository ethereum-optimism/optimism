...
func (m *MeteredL1Fetcher) CallAtHash(ctx context.Context, msg ethereum.CallMsg, blockHash common.Hash) ([]byte, error) {
	defer m.recordTime("CallAtHash")()
	return m.inner.CallAtHash(ctx, msg, blockHash)
}
