...
func TestJovianNetworkTransactions(t *testing.T) {
	...
	require.Equal(t, deployL1BlockSender, common.HexToAddress("0x4210000000000000000000000000000000000007"))
	...
	require.Equal(t, "0x3659cfe60000000000000000000000004f1db3c6abd250ba86e0928471a8f7db3afd88f1", hexutil.Encode(updateL1BlockProxy.Data()))
	...
	require.Equal(t, "0x3659cfe60000000000000000000000003ba4007f5c922fbb33c454b41ea7a1f11e83df2c", hexutil.Encode(updateGasPriceOracle.Data()))
