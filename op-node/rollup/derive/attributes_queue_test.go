...
func TestAttributesQueue(t *testing.T) {
	...
	l1InfoTx, err := L1InfoDepositBytes(&rollupCfg, expectedL1Cfg, safeHead.SequenceNumber+1, l1Info, 0, params.MergedTestChainConfig)
	...
	attrBuilder := NewFetchingAttributesBuilder(cfg, nil, l1Fetcher, l2Fetcher, params.MergedTestChainConfig)
