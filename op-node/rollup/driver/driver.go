...
func NewDriver(
	...
	derivationPipeline := derive.NewDerivationPipeline(log, cfg, verifConfDepth, l2, metrics, syncCfg, listener)
	attrBuilder := derive.NewFetchingAttributesBuilder(cfg, l1, l2, listener)
