...
func envelope(payload *eth.ExecutionPayload) *eth.ExecutionPayloadEnvelopeWithContext {
	return &eth.ExecutionPayloadEnvelopeWithContext{ExecutionPayloadEnvelope: &eth.ExecutionPayloadEnvelope{ExecutionPayload: payload}, TraceContext: context.Background()}
}
