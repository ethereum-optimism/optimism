...
require (
	github.com/ethereum-optimism/optimism/op-batcher v0.8.5
	github.com/ethereum-optimism/optimism/op-bindings v0.8.5
	github.com/ethereum-optimism/optimism/op-node v0.8.5
	github.com/ethereum-optimism/optimism/op-proposer v0.8.5
	github.com/ethereum-optimism/optimism/op-service v0.8.5
