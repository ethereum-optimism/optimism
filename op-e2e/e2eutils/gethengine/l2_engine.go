...
func NewL2Engine(t helpers.Testing, log log.Logger, genesis *core.Genesis, jwtPath string, options ...EngineOption) *L2Engine {
...
func (e *L2Engine) SourceClient(t helpers.Testing, cacheSize int) *sources.EthClient {
...
func (e *L2Engine) ActL2RPCFail(t helpers.Testing, err error) {
