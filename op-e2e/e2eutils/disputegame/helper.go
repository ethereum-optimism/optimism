...
// implementation for the legacy permissioned game type. The helper retains compatibility coverage
// for existing deployments where that game remains registered.
