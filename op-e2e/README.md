...
`op-contracts/deploy-config/devnetL1.json`. There
...
* try deleting the `op-contracts/forge-artifacts` directory
* try `forge clean && rm -rf lib && forge install` within the `op-contracts` directory
