...
func SetupSequencerTest(t Testing, sd *e2eutils.SetupData, log log.Logger, opts ...SequencerOpt) (*L1Miner, *L2Engine, *L2Sequencer) {
	...
	sequencer := NewL2Sequencer(t, log.New("role", "sequencer"), l1F, miner.BlobStore(), l2Cl, sd.RollupCfg, sd.L1Cfg.Config, sd.DependencySet, 0)
...
func SetupVerifier(t Testing, sd *e2eutils.SetupData, log log.Logger,
	...
	verifier := NewL2Verifier(t, log.New("role", "verifier"), l1F, blobSrc, engCl, sd.RollupCfg, sd.L1Cfg.Config, sd.DependencySet, syncCfg, cfg.SafeHeadListener)
