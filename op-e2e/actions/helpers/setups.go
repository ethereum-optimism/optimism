...
func SetupVerifier(t Testing, sd *e2eutils.SetupData, log log.Logger,
	...
	verifier := NewL2Verifier(t, log.New("role", "verifier"), l1F, blobSrc, altda.Disabled, engCl, sd.RollupCfg, sd.DependencySet, syncCfg, cfg.SafeHeadListener, sd.L1Cfg.Config)
