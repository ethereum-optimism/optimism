...
var descriptions = map[string]string{
	...
	// Cannon Kona Dispute Game validations (CKDG)
	"CKDG-10":         "Cannon Kona dispute game implementation not found",
	"CKDG-20":         "Cannon Kona dispute game version mismatch",
	"CKDG-40":         "Cannon Kona dispute game absolute prestate mismatch",
	"CKDG-60":         "Cannon Kona dispute game L2 chain ID mismatch",
	"CKDG-70":         "Cannon Kona dispute game L2 block number not set to 0",
	...
	"CKDG-VM-30":      "Cannon Kona dispute game VM address mismatch",
	"CKDG-ANCHORP-10": "Cannon Kona dispute game anchor state registry version mismatch",
	"CKDG-ANCHORP-20": "Cannon Kona dispute game anchor state registry implementation address mismatch",
	"CKDG-ANCHORP-30": "Cannon Kona dispute game anchor state registry dispute game factory address mismatch",
	"CKDG-ANCHORP-40": "Cannon Kona dispute game anchor state registry root hash mismatch",
	"CKDG-ANCHORP-50": "Cannon Kona dispute game anchor state registry superchain config address mismatch",
	"CKDG-ANCHORP-60": "Cannon Kona dispute game anchor state registry retirement timestamp is not set",
	"CKDG-DWETH-10":   "Cannon Kona dispute game delayed WETH version mismatch",
	"CKDG-DWETH-20":   "Cannon Kona dispute game delayed WETH implementation address mismatch",
	"CKDG-DWETH-30":   "Cannon Kona dispute game delayed WETH owner mismatch",
	"CKDG-DWETH-40":   "Cannon Kona dispute game delayed WETH delay not set to 1 week",
	"CKDG-DWETH-50":   "Cannon Kona dispute game delayed WETH system config address mismatch",
	"CKDG-DWETH-60":   "Cannon Kona dispute game delayed WETH proxy admin mismatch",
	"CKDG-PIMGO-10":   "Cannon Kona dispute game preimage oracle version mismatch",
	"CKDG-PIMGO-20":   "Cannon Kona dispute game preimage oracle challenge period not set to 86400",
	"CKDG-PIMGO-30":   "Cannon Kona dispute game preimage oracle min proposal size not set to 126000",
	"CKDG-GARGS-10":   "Cannon Kona dispute game game args mismatch",
}
