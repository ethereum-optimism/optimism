...
// GasPayingToken is a paid mutator transaction binding the contract method 0x4397dfef.
//
// Solidity: function gasPayingToken() returns(address, uint8)
func (_StandardBridge *StandardBridgeTransactor) GasPayingToken(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "gasPayingToken")
}

// GasPayingToken is a paid mutator transaction binding the contract method 0x4397dfef.
//
// Solidity: function gasPayingToken() returns(address, uint8)
func (_StandardBridge *StandardBridgeSession) GasPayingToken() (*types.Transaction, error) {
	return _StandardBridge.Contract.GasPayingToken(&_StandardBridge.TransactOpts)
}

// GasPayingToken is a paid mutator transaction binding the contract method 0x4397dfef.
//
// Solidity: function gasPayingToken() returns(address, uint8)
func (_StandardBridge *StandardBridgeTransactorSession) GasPayingToken() (*types.Transaction, error) {
	return _StandardBridge.Contract.GasPayingToken(&_StandardBridge.TransactOpts)
}
...
func (_StandardBridge *StandardBridgeTransactor) IsCustomGasToken(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "isCustomGasToken")
}

// IsCustomGasToken is a paid mutator transaction binding the contract method 0x21326849.
//
// Solidity: function isCustomGasToken() returns(bool)
func (_StandardBridge *StandardBridgeSession) IsCustomGasToken() (*types.Transaction, error) {
	return _StandardBridge.Contract.IsCustomGasToken(&_StandardBridge.TransactOpts)
}

// IsCustomGasToken is a paid mutator transaction binding the contract method 0x21326849.
//
// Solidity: function isCustomGasToken() returns(bool)
func (_StandardBridge *StandardBridgeTransactorSession) IsCustomGasToken() (*types.Transaction, error) {
	return _StandardBridge.Contract.IsCustomGasToken(&_StandardBridge.TransactOpts)
}
