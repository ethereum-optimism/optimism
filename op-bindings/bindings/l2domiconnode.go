...
func (_L2DomiconNode *L2DomiconNodeTransactor) IsNodeBroadcast(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _L2DomiconNode.contract.Transact(opts, "IsNodeBroadcast", addr)
}

// IsNodeBroadcast is a paid mutator transaction binding the contract method 0xc0f2acea.
//
// Solidity: function IsNodeBroadcast(address addr) returns(bool)
func (_L2DomiconNode *L2DomiconNodeSession) IsNodeBroadcast(addr common.Address) (*types.Transaction, error) {
	return _L2DomiconNode.Contract.IsNodeBroadcast(&_L2DomiconNode.TransactOpts, addr)
}

// IsNodeBroadcast is a paid mutator transaction binding the contract method 0xc0f2acea.
//
// Solidity: function IsNodeBroadcast(address addr) returns(bool)
func (_L2DomiconNode *L2DomiconNodeTransactorSession) IsNodeBroadcast(addr common.Address) (*types.Transaction, error) {
	return _L2DomiconNode.Contract.IsNodeBroadcast(&_L2DomiconNode.TransactOpts, addr)
}
