...
func (_CrossDomainMessenger *CrossDomainMessengerTransactor) SendSubmitMessage(opts *bind.TransactOpts, _target common.Address, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.contract.Transact(opts, "sendSubmitMessage", _target, _message, _minGasLimit)
}

// SendSubmitMessage is a paid mutator transaction binding the contract method 0xb8920c14.
//
// Solidity: function sendSubmitMessage(address _target, bytes _message, uint32 _minGasLimit) payable returns()
func (_CrossDomainMessenger *CrossDomainMessengerSession) SendSubmitMessage(_target common.Address, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendSubmitMessage(&_CrossDomainMessenger.TransactOpts, _target, _message, _minGasLimit)
}

// SendSubmitMessage is a paid mutator transaction binding the contract method 0xb8920c14.
//
// Solidity: function sendSubmitMessage(address _target, bytes _message, uint32 _minGasLimit) payable returns()
func (_CrossDomainMessenger *CrossDomainMessengerTransactorSession) SendSubmitMessage(_target common.Address, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendSubmitMessage(&_CrossDomainMessenger.TransactOpts, _target, _message, _minGasLimit)
}
