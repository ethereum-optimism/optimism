...
func (_CrossDomainMessenger *CrossDomainMessengerTransactor) GasPayingToken(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CrossDomainMessenger.contract.Transact(opts, "gasPayingToken")
}

// GasPayingToken is a paid mutator transaction binding the contract method 0x4397dfef.
//
// Solidity: function gasPayingToken() returns(address, uint8)
func (_CrossDomainMessenger *CrossDomainMessengerSession) GasPayingToken() (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.GasPayingToken(&_CrossDomainMessenger.TransactOpts)
}

// GasPayingToken is a paid mutator transaction binding the contract method 0x4397dfef.
//
// Solidity: function gasPayingToken() returns(address, uint8)
func (_CrossDomainMessenger *CrossDomainMessengerTransactorSession) GasPayingToken() (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.GasPayingToken(&_CrossDomainMessenger.TransactOpts)
}
...
func (_CrossDomainMessenger *CrossDomainMessengerTransactor) IsCustomGasToken(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CrossDomainMessenger.contract.Transact(opts, "isCustomGasToken")
}

// IsCustomGasToken is a paid mutator transaction binding the contract method 0x21326849.
//
// Solidity: function isCustomGasToken() returns(bool)
func (_CrossDomainMessenger *CrossDomainMessengerSession) IsCustomGasToken() (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.IsCustomGasToken(&_CrossDomainMessenger.TransactOpts)
}

// IsCustomGasToken is a paid mutator transaction binding the contract method 0x21326849.
//
// Solidity: function isCustomGasToken() returns(bool)
func (_CrossDomainMessenger *CrossDomainMessengerTransactorSession) IsCustomGasToken() (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.IsCustomGasToken(&_CrossDomainMessenger.TransactOpts)
}
