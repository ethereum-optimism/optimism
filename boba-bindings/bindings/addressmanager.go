...
const AddressManagerABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"string\",\"name\":\"name\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"newAddress\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"oldAddress\",\"type\":\"address\"}],\"name\":\"AddressSet\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_name\",\"type\":\"string\"}],\"name\":\"getAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_name\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"_address\",\"type\":\"address\"}],\"name\":\"setAddress\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"

// AddressManagerBin is the compiled bytecode used for deploying new contracts.
var AddressManagerBin = ""

// DeployAddressManager deploys a new Ethereum contract, binding an instance of AddressManager to it.
func DeployAddressManager(auth *bind.TransactOpts, backend bind.ContractBackend) (libcommon.Address, types.Transaction, *AddressManager, error) {
	parsed, err := abi.JSON(strings.NewReader(AddressManagerABI))
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, libcommon.FromHex(AddressManagerBin), backend)
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}
...
func NewAddressManager(address libcommon.Address, backend bind.ContractBackend) (*AddressManager, error) {
...
func NewAddressManagerCaller(address libcommon.Address, caller bind.ContractCaller) (*AddressManagerCaller, error) {
...
func NewAddressManagerTransactor(address libcommon.Address, transactor bind.ContractTransactor) (*AddressManagerTransactor, error) {
...
func NewAddressManagerFilterer(address libcommon.Address, filterer bind.ContractFilterer) (*AddressManagerFilterer, error) {
...
func bindAddressManager(address libcommon.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(AddressManagerABI))
	if err != nil {
		return nil, err
	}
...
func (_AddressManager *AddressManagerCaller) GetAddress(opts *bind.CallOpts, _name string) (libcommon.Address, error) {
	var out []interface{}
...
//
// Solidity: function getAddress(string _name) view returns(address)
func (_AddressManager *AddressManagerSession) GetAddress(_name string) (libcommon.Address, error) {
...
//
// Solidity: function getAddress(string _name) view returns(address)
func (_AddressManager *AddressManagerCallerSession) GetAddress(_name string) (libcommon.Address, error) {
	return _AddressManager.Contract.GetAddress(&_AddressManager.CallOpts, _name)
}
...
func (_AddressManager *AddressManagerCaller) Owner(opts *bind.CallOpts) (libcommon.Address, error) {
	var out []interface{}
...
//
// Solidity: function owner() view returns(address)
func (_AddressManager *AddressManagerSession) Owner() (libcommon.Address, error) {
...
//
// Solidity: function owner() view returns(address)
func (_AddressManager *AddressManagerCallerSession) Owner() (libcommon.Address, error) {
	return _AddressManager.Contract.Owner(&_AddressManager.CallOpts)
}
...
func (_AddressManager *AddressManagerTransactor) SetAddress(opts *bind.TransactOpts, _name string, _address libcommon.Address) (types.Transaction, error) {
...
//
// Solidity: function setAddress(string _name, address _address) returns()
func (_AddressManager *AddressManagerSession) SetAddress(_name string, _address libcommon.Address) (types.Transaction, error) {
...
//
// Solidity: function setAddress(string _name, address _address) returns()
func (_AddressManager *AddressManagerTransactorSession) SetAddress(_name string, _address libcommon.Address) (types.Transaction, error) {
	return _AddressManager.Contract.SetAddress(&_AddressManager.TransactOpts, _name, _address)
}
...
func (_AddressManager *AddressManagerTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner libcommon.Address) (types.Transaction, error) {
...
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_AddressManager *AddressManagerSession) TransferOwnership(newOwner libcommon.Address) (types.Transaction, error) {
...
func (_AddressManager *AddressManagerFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []libcommon.Address, newOwner []libcommon.Address) (*AddressManagerOwnershipTransferredIterator, error) {
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_AddressManager *AddressManagerFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *AddressManagerOwnershipTransferred, previousOwner []libcommon.Address, newOwner []libcommon.Address) (event.Subscription, error) {
