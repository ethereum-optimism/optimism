...
const DeterministicDeploymentProxyABI = "[{\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"fallback\",\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"},{\"internalType\":\"bytes32\",\"name\":\"creationCode\",\"type\":\"bytes\"}]}]"

// DeterministicDeploymentProxyBin is the compiled bytecode used for deploying new contracts.
var DeterministicDeploymentProxyBin = "0x604580600e600039806000f350fe7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe03601600081602082378035828234f58015156039578182fd5b8082525050506014600cf3"
...
func DeployDeterministicDeploymentProxy(auth *bind.TransactOpts, backend bind.ContractBackend) (libcommon.Address, types.Transaction, *DeterministicDeploymentProxy, error) {
	parsed, err := abi.JSON(strings.NewReader(DeterministicDeploymentProxyABI))
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, libcommon.FromHex(DeterministicDeploymentProxyBin), backend)
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}
...
func NewDeterministicDeploymentProxy(address libcommon.Address, backend bind.ContractBackend) (*DeterministicDeploymentProxy, error) {
...
func NewDeterministicDeploymentProxyCaller(address libcommon.Address, caller bind.ContractCaller) (*DeterministicDeploymentProxyCaller, error) {
...
func NewDeterministicDeploymentProxyTransactor(address libcommon.Address, transactor bind.ContractTransactor) (*DeterministicDeploymentProxyTransactor, error) {
...
func NewDeterministicDeploymentProxyFilterer(address libcommon.Address, filterer bind.ContractFilterer) (*DeterministicDeploymentProxyFilterer, error) {
...
func bindDeterministicDeploymentProxy(address libcommon.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(DeterministicDeploymentProxyABI))
	if err != nil {
		return nil, err
	}
