...
const Create2DeployerABI = "[{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"},{\"internalType\":\"bytes32\",\"name\":\"codeHash\",\"type\":\"bytes32\"}],\"name\":\"computeAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"},{\"internalType\":\"bytes32\",\"name\":\"codeHash\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"deployer\",\"type\":\"address\"}],\"name\":\"computeAddressWithDeployer\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"pure\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"value\",\"type\":\"uint256\"},{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"},{\"internalType\":\"bytes\",\"name\":\"code\",\"type\":\"bytes\"}],\"name\":\"deploy\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"value\",\"type\":\"uint256\"},{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"}],\"name\":\"deployERC1820Implementer\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]"

// Create2DeployerBin is the compiled bytecode used for deploying new contracts.
var Create2DeployerBin = ""

// DeployCreate2Deployer deploys a new Ethereum contract, binding an instance of Create2Deployer to it.
func DeployCreate2Deployer(auth *bind.TransactOpts, backend bind.ContractBackend) (libcommon.Address, types.Transaction, *Create2Deployer, error) {
	parsed, err := abi.JSON(strings.NewReader(Create2DeployerABI))
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, libcommon.FromHex(Create2DeployerBin), backend)
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}
...
func NewCreate2Deployer(address libcommon.Address, backend bind.ContractBackend) (*Create2Deployer, error) {
...
func NewCreate2DeployerCaller(address libcommon.Address, caller bind.ContractCaller) (*Create2DeployerCaller, error) {
...
func NewCreate2DeployerTransactor(address libcommon.Address, transactor bind.ContractTransactor) (*Create2DeployerTransactor, error) {
...
func NewCreate2DeployerFilterer(address libcommon.Address, filterer bind.ContractFilterer) (*Create2DeployerFilterer, error) {
...
func bindCreate2Deployer(address libcommon.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(Create2DeployerABI))
	if err != nil {
		return nil, err
	}
...
func (_Create2Deployer *Create2DeployerCaller) ComputeAddress(opts *bind.CallOpts, salt [32]byte, codeHash [32]byte) (libcommon.Address, error) {
	var out []interface{}
...
//
// Solidity: function computeAddress(bytes32 salt, bytes32 codeHash) view returns(address)
func (_Create2Deployer *Create2DeployerSession) ComputeAddress(salt [32]byte, codeHash [32]byte) (libcommon.Address, error) {
...
//
// Solidity: function computeAddress(bytes32 salt, bytes32 codeHash) view returns(address)
func (_Create2Deployer *Create2DeployerCallerSession) ComputeAddress(salt [32]byte, codeHash [32]byte) (libcommon.Address, error) {
	return _Create2Deployer.Contract.ComputeAddress(&_Create2Deployer.CallOpts, salt, codeHash)
}
...
func (_Create2Deployer *Create2DeployerCaller) ComputeAddressWithDeployer(opts *bind.CallOpts, salt [32]byte, codeHash [32]byte, deployer libcommon.Address) (libcommon.Address, error) {
	var out []interface{}
...
//
// Solidity: function computeAddressWithDeployer(bytes32 salt, bytes32 codeHash, address deployer) pure returns(address)
func (_Create2Deployer *Create2DeployerSession) ComputeAddressWithDeployer(salt [32]byte, codeHash [32]byte, deployer libcommon.Address) (libcommon.Address, error) {
...
//
// Solidity: function computeAddressWithDeployer(bytes32 salt, bytes32 codeHash, address deployer) pure returns(address)
func (_Create2Deployer *Create2DeployerCallerSession) ComputeAddressWithDeployer(salt [32]byte, codeHash [32]byte, deployer libcommon.Address) (libcommon.Address, error) {
	return _Create2Deployer.Contract.ComputeAddressWithDeployer(&_Create2Deployer.CallOpts, salt, codeHash, deployer)
}
...
// DeployParams is an auto generated read-only Go binding of transcaction calldata params
...
//
// Solidity: function deploy(uint256 value, bytes32 salt, bytes code) returns()
func ParseDeploy(calldata []byte) (*DeployParams, error) {
	if len(calldata) <= 4 {
		return nil, fmt.Errorf("invalid calldata input")
	}

	_abi, err := abi.JSON(strings.NewReader(Create2DeployerABI))
	if err != nil {
	...
	var paramsResult = new(DeployParams)
	...
	return &DeployParams{
		Param_value: out0, Param_salt: out1, Param_code: out2,
	}, nil
}

// DeployERC1820ImplementerParams is an auto generated read-only Go binding of transcaction calldata params
type DeployERC1820ImplementerParams struct {
	Param_value *big.Int
	Param_salt  [32]byte
}

// Parse DeployERC1820Implementer method from calldata of a transaction
//
// Solidity: function deployERC1820Implementer(uint256 value, bytes32 salt) returns()
func ParseDeployERC1820Implementer(calldata []byte) (*DeployERC1820ImplementerParams, error) {
	if len(calldata) <= 4 {
		return nil, fmt.Errorf("invalid calldata input")
	}
	...
	out, err := _abi.Methods["deployERC1820Implementer"].Inputs.Unpack(calldata[4:])
	if err != nil {
		return nil, fmt.Errorf("failed to unpack deployERC1820Implementer params data: %w", err)
	}

	var paramsResult = new(DeployERC1820ImplementerParams)
	value := reflect.ValueOf(paramsResult).Elem()
	...
	return &DeployERC1820ImplementerParams{
		Param_value: out0, Param_salt: out1,
	}, nil
}
