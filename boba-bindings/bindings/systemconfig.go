...
func ParseInitialize(calldata []byte) (*InitializeParams, error) {
	...
	return &InitializeParams{
		Param__owner: out0, Param__overhead: out1, Param__scalar: out2, Param__batcherHash: out3, Param__gasLimit: out4, Param__unsafeBlockSigner: out5, Param__config: out6,
	}, nil
}
