...
const L1BlockNumberABI = "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"stateMutability\":\"payable\",\"type\":\"fallback\"},{\"inputs\":[],\"name\":\"getL1BlockNumber\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"version\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]"

// L1BlockNumberBin is the compiled bytecode used for deploying new contracts.
var L1BlockNumberBin = ""

// DeployL1BlockNumber deploys a new Ethereum contract, binding an instance of L1BlockNumber to it.
func DeployL1BlockNumber(auth *bind.TransactOpts, backend bind.ContractBackend) (libcommon.Address, types.Transaction, *L1BlockNumber, error) {
	parsed, err := abi.JSON(strings.NewReader(L1BlockNumberABI))
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, libcommon.FromHex(L1BlockNumberBin), backend)
	if err != nil {
		return libcommon.Address{}, nil, nil, err
	}
...
func NewL1BlockNumber(address libcommon.Address, backend bind.ContractBackend) (*L1BlockNumber, error) {
...
func NewL1BlockNumberCaller(address libcommon.Address, caller bind.ContractCaller) (*L1BlockNumberCaller, error) {
...
func NewL1BlockNumberTransactor(address libcommon.Address, transactor bind.ContractTransactor) (*L1BlockNumberTransactor, error) {
...
func NewL1BlockNumberFilterer(address libcommon.Address, filterer bind.ContractFilterer) (*L1BlockNumberFilterer, error) {
...
func bindL1BlockNumber(address libcommon.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(L1BlockNumberABI))
	if err != nil {
		return nil, err
	}
