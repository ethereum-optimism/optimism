...
func (generator *BindGenGeneratorRemote) CompareDeployedBytecodeWithRpc(contractMetadata *RemoteContractMetadata, chain string) error {
	...
	var deployment libcommon.Address
	switch chain {
	case "eth":
	...
	if deployment != (libcommon.Address{}) {
		bytecode, err := client.CodeAt(context.Background(), libcommon.HexToAddress(deployment.Hex()), nil)
		if err != nil {
...
func (generator *BindGenGeneratorRemote) writeAllOutputs(contractMetadata *RemoteContractMetadata, fileTemplate string) error {
	...
	err = genContractBindings(generator.Logger, generator.MonorepoBasePath, abiFilePath, bytecodeFilePath, generator.BindingsPackageName, contractMetadata.Name, map[string]struct{}{}, map[string]struct{}{})
	if err != nil {
		return err
	}
