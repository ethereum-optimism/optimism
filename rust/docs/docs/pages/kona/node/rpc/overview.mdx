...
| ---------------------------- | ------------------------------------------------------------------------------------------------------ | --------- |
| [`p2p`](/kona/node/rpc/p2p)        | The `p2p` API allows you to configure the p2p stack.                                                   | Maybe     |
| [`rollup`](/kona/node/rpc/rollup)  | The `rollup` API provides OP Stack specific rpc methods.                                               | No        |
| [`admin`](/kona/node/rpc/admin)    | The `admin` API allows you to configure your node.                                                     | **Yes**   |
