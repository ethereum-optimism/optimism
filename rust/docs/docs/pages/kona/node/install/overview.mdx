...
-   [Docker images](/kona/node/install/docker)
-   [Pre-built binaries](/kona/node/install/binaries)
-   [Building from source](/kona/node/install/source)

:::note
If you have Docker installed, we recommend using the [Docker recipe](/kona/node/run/docker) configuration
