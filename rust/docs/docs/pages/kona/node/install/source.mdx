...
Visit the [Prerequisites](/kona/node/install/overview) for details on installing Rust and `just`.
...
binary](/kona/node/install/binaries).
...
- Read the [Overview](/kona/intro/overview) to understand Kona's architecture
- Check out the [Binaries](/kona/node/run/binary) documentation
- Explore the [Examples](/kona/sdk/examples/intro)
