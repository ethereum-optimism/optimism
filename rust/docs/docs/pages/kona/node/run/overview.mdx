...
Now that you have [installed the `kona-node`](/kona/node/install/overview),
it's time to run it.
...
-   **[Configuration](/kona/node/configuration)** - Configure your node
-   **[Monitoring](/kona/node/monitoring)** - Set up logs, metrics, and observability
