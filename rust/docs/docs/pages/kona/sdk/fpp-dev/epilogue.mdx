...
[execution phase](/kona/sdk/fpp-dev/execution). In most programs, this entails comparing the outputs of the execution phase
to portions of the bootstrap data made available during the [prologue phase](/kona/sdk/fpp-dev/prologue).
