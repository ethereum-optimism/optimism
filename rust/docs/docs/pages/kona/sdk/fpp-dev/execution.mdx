...
This phase consumes the outputs of the [prologue phase](/kona/sdk/fpp-dev/prologue), and performs the bulk of the verifiable
computation. After execution has concluded, the outputs are passed along to the [epilogue phase](/kona/sdk/fpp-dev/epilogue) for
final verification.
