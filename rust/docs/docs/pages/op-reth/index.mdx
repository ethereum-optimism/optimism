...
- [Running op-reth on OP Stack chains](/op-reth/run/opstack) — Install and run op-reth with a rollup node.
- [Sync OP Mainnet](/op-reth/run/faq/sync-op-mainnet) — Import Bedrock state and sync OP Mainnet from scratch.
- [CLI Reference](/op-reth/cli/op-reth) — Full command-line reference for op-reth.
