...
pub use api::{
    ...
    OpProofsProviderRw, OpProofsSnapshotInitProvider, OpProofsSnapshotProviderRO,
    OpProofsSnapshotProviderRW, OpProofsSnapshotStore, OpProofsStore, ProofWindowRange,
    SnapshotInitAnchor, SnapshotInitStatus,
};
