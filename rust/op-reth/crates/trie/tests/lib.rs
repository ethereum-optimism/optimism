...
// These shared tests are driven by small value fixtures and many Arc/MdbxTx drops;
// the usual pedantic/nursery categories fire on every fixture builder call.
#![allow(
