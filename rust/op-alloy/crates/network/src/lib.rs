...
// NOTE: `NetworkWallet<Optimism>` for `EthereumWallet` is provided by the blanket impl in
// `alloy_network` (since alloy 1.8) because `OpTypedTransaction: SignableTransaction` and
