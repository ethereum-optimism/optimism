...
# op-reth, revm-ee-tests, op-reth-test-engine, lokahi and lokahi-interop are
# workspace members but not kona-client dependencies. We need their Cargo.toml
# files so the workspace resolves.
...
COPY rust/lokahi-interop/ /app/rust/lokahi-interop/
