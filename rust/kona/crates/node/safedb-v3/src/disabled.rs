//! A no-op [`SafeDbV3`] implementation for hosts that do not record derivation.

use crate::{
    error::SafeDbError,
    traits::{SafeDbV3, SafeHeadRecord},
};
use alloy_eips::BlockNumHash;
use kona_protocol::L2BlockInfo;

/// A [`SafeDbV3`] that records nothing and reports itself disabled.
///
...
pub struct DisabledDatabaseV3;

impl SafeDbV3 for DisabledDatabaseV3 {
