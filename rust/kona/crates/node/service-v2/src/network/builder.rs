...
use crate::network::{NetworkBuilderError, NetworkConfig, UnstartedNetwork};

/// Constructs a [`UnstartedNetwork`] for the OP Stack Consensus Layer.
#[derive(Debug)]
...
impl NetworkBuilder {
    ...
    /// Builds the [`UnstartedNetwork`].
    pub fn build(self) -> Result<UnstartedNetwork, NetworkBuilderError> {
