//! Module containing a [`TxDeposit`] builder for the Lagoon network upgrade transactions.
//!
//! Lagoon network upgrade transactions are defined in the [OP Stack Specs][specs].
//!
...
/// The Lagoon network upgrade transactions.
...
impl Lagoon {
    ...
    /// Returns the list of always-on [`TxDeposit`]s for the Lagoon network upgrade.
    ///
