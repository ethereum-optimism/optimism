...
/// UPSTREAM-MIRROR(copy): alloy-evm@0.39.0 `alloy_evm::eth::block::EthBlockExecutor`
///
...
/// does not. Upstream's Amsterdam state-gas capacity check is inapplicable until an OP fork maps
/// to Amsterdam semantics.
