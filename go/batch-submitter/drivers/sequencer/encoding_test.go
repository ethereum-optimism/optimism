...
type AppendSequencerBatchParamsTest struct {
	...
	Txs                   []string                 `json:"txs"`
	Type                  sequencer.BatchType      `json:"type"`
}
...
func init() {
	...
	var cases AppendSequencerBatchParamsTestCases
	err = json.Unmarshal(data, &cases)
	if err != nil {
		panic(err)
	}
	appendSequencerBatchParamTests = cases
}
...
func testAppendSequencerBatchParamsEncodeDecode(
	...
	if expParams.Contexts == nil {
		expParams.Contexts = make([]sequencer.BatchContext, 0)
	}
