...
func L1(globalState *state.State, chainID common.Hash) (*L1Contracts, error) {
	...
	l1Contracts := L1Contracts{
		...
		ImplementationsDeployment: ImplementationsDeployment{
			OpcmAddress:                             globalState.ImplementationsDeployment.OpcmImpl,
			DelayedWETHImplAddress:                  globalState.ImplementationsDeployment.DelayedWethImpl,
			OptimismPortalImplAddress:               globalState.ImplementationsDeployment.OptimismPortalImpl,
			ETHLockboxImplAddress:                   globalState.ImplementationsDeployment.EthLockboxImpl,
			PreimageOracleSingletonAddress:          globalState.ImplementationsDeployment.PreimageOracleImpl,
			MipsSingletonAddress:                    globalState.ImplementationsDeployment.MipsImpl,
			SystemConfigImplAddress:                 globalState.ImplementationsDeployment.SystemConfigImpl,
			L1CrossDomainMessengerImplAddress:       globalState.ImplementationsDeployment.L1CrossDomainMessengerImpl,
			L1ERC721BridgeImplAddress:               globalState.ImplementationsDeployment.L1Erc721BridgeImpl,
			L1StandardBridgeImplAddress:             globalState.ImplementationsDeployment.L1StandardBridgeImpl,
			OptimismMintableERC20FactoryImplAddress: globalState.ImplementationsDeployment.OptimismMintableErc20FactoryImpl,
			DisputeGameFactoryImplAddress:           globalState.ImplementationsDeployment.DisputeGameFactoryImpl,
		},
	}
