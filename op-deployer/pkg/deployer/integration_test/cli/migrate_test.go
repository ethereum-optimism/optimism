...
// TestCLIMigrateV2 tests the migrate CLI command for OPCM
func TestCLIMigrateV2(t *testing.T) {
	...
	// Set global deploy overrides with devFeatureBitmap
