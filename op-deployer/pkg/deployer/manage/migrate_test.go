...
func TestInteropMigration(t *testing.T) {
	...
	devBitmap := deployer.EnableDevFeature(common.Hash{}, deployer.OptimismPortalInteropDevFlag)
	...
	// Prepare game args - ABI encode the prestate
