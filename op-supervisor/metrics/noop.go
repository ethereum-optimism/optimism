...
func (m *noopMetrics) RecordCrossUnsafe(_ eth.ChainID, _ messages.BlockSeal) {}
func (m *noopMetrics) RecordCrossSafe(_ eth.ChainID, _ messages.BlockSeal)   {}
func (m *noopMetrics) RecordLocalSafe(_ eth.ChainID, _ messages.BlockSeal)   {}
func (m *noopMetrics) RecordLocalUnsafe(_ eth.ChainID, _ messages.BlockSeal) {}
