...
Commands:
  ...
  initialize-op-proofs  Initializes the proofs storage with the current state of the chain
  unwind-op-proofs      Unwinds the proofs storage to a specific block number
  prune-op-proofs       Prunes the proofs storage by removing old proof history and state updates
