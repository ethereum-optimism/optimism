...
func TestABIWordLayout(t *testing.T) {
	...
	want := []string{
		...
		// Continuation fields: anchor height, anchor root, recovery digest, private parent root.
...
func TestSolidityProducesTheSameBytes(t *testing.T) {
	const solidityEmptyProof = ""
	const solidityWithProof = ""
