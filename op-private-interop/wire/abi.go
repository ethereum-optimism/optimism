// Package wire owns the canonical projection call encodings shared by producers and derivation.
package wire
...
// the public projection -- predeploys.EventReplayerAddr (0x...002F) and predeploys.ClaimRegistryAddr
// (0x...002E), placed by the deterministic public-projection genesis -- but a BatcherTxBuilder starts
