...
func setupOracle(t devtest.T, el *dsl.L2ELNode, blockTime time.Duration) *txinclude.OperatorCostOracle {
	oracle := txinclude.NewOperatorCostOracle(&batchRPCClient{
