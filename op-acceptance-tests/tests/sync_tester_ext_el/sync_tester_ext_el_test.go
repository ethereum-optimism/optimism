...
func TestSyncTesterExtEL(gt *testing.T) {
	...
	require.Equal(eth.ChainIDFromUInt64(11155420), syncTesterChainID, "SyncTester should be on chain 11155420")
	...
	dsl.CheckAll(t,
		sys.L2CL.AdvancedFn(types.LocalUnsafe, 31987002, 300),
	)
