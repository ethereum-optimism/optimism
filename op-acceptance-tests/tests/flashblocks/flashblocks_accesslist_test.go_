...
func TestFlashblocksAccesslistsAL(gt *testing.T) {
	...
	totalFlashblocksProduced := evaluateFlashblocksStreamAL(t, logger, streamedMessages, failureTolerance)
...
func evaluateFlashblocksStreamAL(t devtest.T, logger log.Logger, streamedMessages []string, failureTolerance int) int {
