...
docker pull ghcr.io/ethereum-optimism/optimism/kona-node:nightly
docker pull ghcr.io/ethereum-optimism/optimism/kona-host:nightly
docker pull ghcr.io/ethereum-optimism/optimism/kona-supervisor:nightly

# Pull a specific date's nightly build
docker pull ghcr.io/ethereum-optimism/optimism/kona-node:nightly-2024-12-10
```
...
To run the workflow manually, navigate over to the ["Build and Publish Docker Image"](https://github.com/ethereum-optimism/optimism/actions)
