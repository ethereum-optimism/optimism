...
func WithSuperchain(id stack.SuperchainID) stack.Option {
	return func(setup *stack.Setup) {
		...
		setup.System.AddSuperchain(stack.NewSuperchain(stack.SuperchainConfig{
...
func WithSupervisor(id stack.SupervisorID) stack.Option {
	return func(setup *stack.Setup) {
		...
		setup.System.AddSupervisor(stack.NewSupervisor(stack.SupervisorConfig{
			CommonConfig: setup.CommonConfig(),
			ID:           id,
...
func WithCluster(id stack.ClusterID) stack.Option {
	return func(setup *stack.Setup) {
		...
		setup.System.AddCluster(stack.NewCluster(stack.ClusterConfig{
			CommonConfig:  setup.CommonConfig(),
			ID:            id,
