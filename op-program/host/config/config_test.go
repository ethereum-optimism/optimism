...
func validConfig() *Config {
	cfg := NewSingleChainConfig(validRollupConfig, validL1ChainConfig, validL2Genesis, validL1Head, validL2Head, validL2OutputRoot, validL2Claim, validL2ClaimBlockNum)
