...
func Main(logger log.Logger) {
	...
	preimageOracle := preimage.CreatePreimageChannel()
	preimageHinter := preimage.CreateHinterChannel()
	if err := RunProgram(context.Background(), logger, preimageOracle, preimageHinter); errors.Is(err, cldr.ErrClaimNotValid) {
