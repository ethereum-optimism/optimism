...
func TestAppendToChain(t *testing.T) {
	...
	_, err := chain.InsertBlockWithoutSetHead(context.Background(),newBlock, false)
...
func TestGetReceiptsByBlockHash(t *testing.T) {
	...
	_, err := chain.InsertBlockWithoutSetHead(context.Background(),blocks[1], false)
	require.NoError(t, err)
	require.Equal(t,
...
func TestRejectBlockWithStateRootMismatch(t *testing.T) {
	...
	_, err := chain.InsertBlockWithoutSetHead(context.Background(),invalidBlock, false)
...
func TestGetHeaderByNumber(t *testing.T) {
	...
	t.Run("AppendedMultipleBlocks", func(t *testing.T) {
		...
		newBlock2 := blocks[4]
		newBlock3 := blocks[5]
		_, err := chain.InsertBlockWithoutSetHead(context.Background(),newBlock1, false)
		require.NoError(t, err)
		_, err = chain.InsertBlockWithoutSetHead(context.Background(),newBlock2, false)
		require.NoError(t, err)
		_, err = chain.InsertBlockWithoutSetHead(context.Background(),newBlock3, false)
		require.NoError(t, err)
