...
Operationally, the Fault Proof VM is a state transition function. This state transition is referred to as a *Step*,
...
The post-state of a step updates the `nextPC`, indicating instruction following the `pc`.
