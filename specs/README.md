...
- **Fast:** When users send transactions, they get reliable confirmations with low-latency.
  ...
  seconds.
- **Scalable:** It should be possible to handle an enormous number of transactions per second which will enable the system to charge low fees. 
...
- **Decentralizable:** Optimism must be designed to avail itself of the security and censorship-resistant guarantees achieved by a decentralized system. 
