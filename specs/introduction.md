...
In general, specifications may use "the sequencer" to be a stand-in term for the consensus protocol operated by multiple sequencers.
...
![Diagram of Depositing and Sending Transactions](./assets/sequencer-handling-depoandsits-and-transactions.svg)
